...
{
    public class TSSM3203 : AMissionControl
    {
        ...
        private int bossFrontID = 3208;

        private int bossSecondID = 3209;
        ...
        public override void OnPrepareNewGame()
        {
            ...
            firstBoss.Degree = 1;
            firstBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TSSM3203.msg1"), 0, 3000);
            ...
            seconBoss.Degree = 2;
            seconBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TSSM3203.msg2"), 0, 9000);
