...
namespace Fighting.Server
{
    public class ServerClient : BaseClient
    {
        ...
        public void SendStopGame(int roomId, int gameId) => this.SendTCP(new GSPacketIn((short)68)
        {
            Parameter1 = roomId,
            Parameter2 = gameId
        });

        public void SendGamePlayerId(IGamePlayer player) => this.SendTCP(new GSPacketIn((short)33)
        {
        ...
        public void SendPlayerAddOffer(int playerId, int value) => this.SendTCP(new GSPacketIn((short)51, playerId)
        {
            Parameter1 = value
        });

        public void SendDisconnectPlayer(int playerId) => this.SendTCP(new GSPacketIn((short)34, playerId));
        ...
        public void SendFightAddOffer(int playerid, int offter) => this.SendTCP(new GSPacketIn((short)201, playerid)
        {
            Parameter1 = offter
        });

        public void SendFightOneBloodIsWin(int playerid, eRoomType roomType) => this.SendTCP(new GSPacketIn((short)200, playerid)
        {
        ...
        public void SendPlayerAddGold(int playerId, int value) => this.SendTCP(new GSPacketIn((short)38, playerId)
        {
            Parameter1 = value
        });

        public void SendPlayerAddMoney(int playerId, int value, bool isAll) => this.SendTCP(new GSPacketIn((short)70, playerId)
        {
            Parameter1 = value,
            Parameter2 = isAll ? 1 : 0
        });

        public void SendPlayerAddMoneyLock(int playerId, int value) => this.SendTCP(new GSPacketIn((short)202, playerId)
        {
            Parameter1 = value
        });

        public void SendPlayerAddGiftToken(int playerId, int value) => this.SendTCP(new GSPacketIn((short)71, playerId)
        {
            Parameter1 = value
        });

        public void SendAddEliteGameScore(int playerId, int value) => this.SendTCP(new GSPacketIn((short)204, playerId)
        {
            Parameter1 = value
        });

        public void SendRemoveEliteGameScore(int playerId, int value) => this.SendTCP(new GSPacketIn((short)205, playerId)
        {
            Parameter1 = value
        });

        public void SendEliteGameWinUpdate(int playerId) => this.SendTCP(new GSPacketIn((short)206, playerId));

        public void SendPlayerAddGP(int playerId, int value) => this.SendTCP(new GSPacketIn((short)39, playerId)
        {
            Parameter1 = value
        });

        public void SendPlayerRemoveGP(int playerId, int value) => this.SendTCP(new GSPacketIn((short)49, playerId)
        {
            Parameter1 = value
        });
        ...
        public void SendBeginFightNpc(int playerId, int RoomType, int GameType, int OrientRoomId, int playerCount)
        {
            ...
            pkg.WriteInt(playerCount); //Quantidade de jogadores na partida
            this.SendTCP(pkg);
        }

        public void SendPlayerRemoveHealstone(int playerId) => this.SendTCP(new GSPacketIn((short)73, playerId));
        ...
        public override string ToString() => string.Format("Server Client: {0} IsConnected:{1}  RoomCount:{2}", (object)0, (object)this.IsConnected, (object)this.dictionary_0.Count);
