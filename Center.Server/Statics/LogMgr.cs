...
namespace Center.Server.Statics
{
  public class LogMgr
  {
    ...
    public static bool Setup() => LogMgr.Setup(LogMgr.GameType, LogMgr.ServerID, LogMgr.AreaID);
    ...
    public static int AreaID => int.Parse(ConfigurationManager.AppSettings[nameof (AreaID)]);

    public static int GameType => int.Parse(ConfigurationManager.AppSettings[nameof (GameType)]);
    ...
    public static int ServerID => int.Parse(ConfigurationManager.AppSettings[nameof (ServerID)]);
  }
}
