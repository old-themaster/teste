...
namespace Center.Server
{
  public class ServerMgr
  {
    ...
    public static ServerInfo GetServerInfo(int id) => ServerMgr._list.ContainsKey(id) ? ServerMgr._list[id] : (ServerInfo) null;
    ...
    public static ServerInfo[] Servers => ServerMgr._list.Values.ToArray<ServerInfo>();
  }
}
