...
namespace GameServerScript.AI.Messions
{
    public class TNSM3103 : AMissionControl
    {
        ...
        private int bossFrontID = 3108;

        private int bossSecondID = 3109;
        ...
        public override void OnPrepareNewGame()
        {
            ...
            firstBoss.Degree = 1;
            firstBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TNSM3103.msg1"), 0, 3000);
            ...
            seconBoss.Degree = 2;
            seconBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TNSM3103.msg2"), 0, 9000);
