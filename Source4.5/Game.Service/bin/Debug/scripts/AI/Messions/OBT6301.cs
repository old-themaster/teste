...
{
    public class OBT6301 : AMissionControl
    {
        ...
        {
            re1 = Game.Random.Next(-6, 6);
            re2 = Game.Random.Next(-6, 6);
            re3 = Game.Random.Next(-6, 6);
            re4 = Game.Random.Next(-6, 6);
            re5 = Game.Random.Next(-6, 6);
            re6 = Game.Random.Next(-6, 6);

            ad1 = Game.Random.Next(-6, 6);
            ad2 = Game.Random.Next(-6, 6);
            ad3 = Game.Random.Next(-6, 6);
            ad4 = Game.Random.Next(-6, 6);
            ad5 = Game.Random.Next(-6, 6);
