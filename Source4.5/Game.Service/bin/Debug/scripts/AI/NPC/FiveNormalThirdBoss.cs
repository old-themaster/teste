...
namespace GameServerScript.AI.NPC
{
    public class FiveNormalThirdBoss : ABrain
    {
        ...
        private int m_npcId1 = 5122;

        private int m_npcId2 = 5123;

        private int m_npcId3 = 5124;

        private int m_npcEnemyId = 5104;

        private int m_countForzenCanKill = 1;
        ...
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg3")
        };

        private string[] CallNpc3Say =
        {
            "Quero torturar sem piedade <span class='red'>{0}</span>, sem piedade!", // GameServerScript.AI.NPC.FiveNormalBossThird.msg4
            "<span class='red'>{0}</span>, já chegou a sua vez!", // GameServerScript.AI.NPC.FiveNormalBossThird.msg5
            "Feche, quero fechar <span class='red'>{0}</span>!", // GameServerScript.AI.NPC.FiveNormalBossThird.msg6
            "<span class='red'>{0}</span>, Veja isso", // GameServerScript.AI.NPC.FiveNormalBossThird.msg7
            "Todo o mundo olhê, <span class='red'>{0}</span> já será executado." // GameServerScript.AI.NPC.FiveNormalBossThird.msg8
        };

        private string[] GlobalAttackSay =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg10")
        };

        private string[] CallNpc1Say =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg11"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg12")
        };

        private string[] OnShootedChat =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg13"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg14"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg15")
        };

        private string[] KillPlayerChat =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg16"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg17"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg18")
        };
