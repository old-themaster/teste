...
namespace Fighting.Server.Rooms
{
    public class ProxyRoom
    {
        ...
        public ServerClient Client => this.serverClient_0;
        ...
        public bool isAutoBot => this.bool_2;
        ...
        public int EliteGameType => this.rYyHcnovuT;

        public int ZoneId => this.int_5;
        ...
        public void SendToAll(GSPacketIn pkg, IGamePlayer except) => this.serverClient_0.SendToRoom(this.int_1, pkg, except);
        ...
        public void Dispose() => this.serverClient_0.RemoveRoom(this.int_1, this);

        public override string ToString() => string.Format("RoomId:{0} OriendId:{1} PlayerCount:{2},IsPlaying:{3},GuildId:{4},GuildName:{5}", (object)this.int_0, (object)this.int_1, (object)this.list_0.Count, (object)this.IsPlaying, (object)this.GuildId, (object)this.GuildName);
    }
}
