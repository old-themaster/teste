...
namespace SqlDataProvider.Data
{
  public class CommConfigInfo
  {
    ...
    {
      get => this._ParaDate1;
      set => this._ParaDate1 = value;
    }

    public DateTime ParaDate2
    {
      get => this._ParaDate2;
      set => this._ParaDate2 = value;
    }

    public DateTime ParaDate3
    {
      get => this._ParaDate3;
      set => this._ParaDate3 = value;
    }

    public int ParaNumber1
    {
      get => this._ParaNumber1;
      set => this._ParaNumber1 = value;
    }

    public int ParaNumber2
    {
      get => this._ParaNumber2;
      set => this._ParaNumber2 = value;
    }

    public int ParaNumber3
    {
      get => this._ParaNumber3;
      set => this._ParaNumber3 = value;
    }

    public string ParaString1
    {
      get => this._ParaString1;
      set => this._ParaString1 = value;
    }

    public string ParaString2
    {
      get => this._ParaString2;
      set => this._ParaString2 = value;
    }

    public string ParaString3
    {
      get => this._ParaString3;
      set => this._ParaString3 = value;
    }
  }
}
