...
namespace SqlDataProvider.Data
{
    public class UsersPetInfo : DataObject
    {
        ...
        public int Attack
        {
            get => this.int_4 - this.method_1(this.int_4);
            set
            {
                this.int_4 = value;
                this._isDirty = true;
        ...
        public int Defence
        {
            get => this.int_5 - this.method_1(this.int_5);
            set
            {
                this.int_5 = value;
                this._isDirty = true;
        ...
        public int Luck
        {
            get => this.int_6 - this.method_1(this.int_6);
            set
            {
                this.int_6 = value;
                this._isDirty = true;
        ...
        public int Agility
        {
            get => this.int_7 - this.method_1(this.int_7);
            set
            {
                this.int_7 = value;
                this._isDirty = true;
        ...
        public int Blood
        {
            get => this.int_8 - this.method_1(this.int_8);
            set
            {
                this.int_8 = value;
                this._isDirty = true;
        ...
        public int Damage
        {
            get => this.int_9 - this.method_1(this.int_9);
            set
            {
                this.int_9 = value;
                this._isDirty = true;
        ...
        public int Guard
        {
            get => this.int_10 - this.method_1(this.int_10);
            set
            {
                this.int_10 = value;
                this._isDirty = true;
        ...
        private int method_1(int int_32)
        {
            ...
            return this.method_0() == 1 ? int_32 * 40 / 100 : 0;
        }
        ...
        public int TotalBlood => this.Blood + this.int_30;

        public int TotalDamage => this.Damage;

        public int TotalGuard => this.Guard;

        public object EquipList { get; set; }
        ...
        public UsersPetInfo() => this.list_0 = new List<PetEquipInfo>();
    }
}
