...
namespace Game.Base
{
  public class CommandMgr
  {
    ...
    {
      get => CommandMgr.m_disabledarray;
      set => CommandMgr.m_disabledarray = value == null ? new string[0] : value;
    }

    public static GameCommand GetCommand(string cmd) => CommandMgr.m_cmds[(object) cmd] as GameCommand;
    ...
    [ScriptLoadedEvent]
    public static void OnScriptCompiled(RoadEvent ev, object sender, EventArgs args) => CommandMgr.LoadCommands();
                    ...
                    else
                    {
                      ...
                      if (customAttribute.Aliases != null)
                      {
                        foreach (string alias in customAttribute.Aliases)
                          CommandMgr.m_cmds.Add((object) alias, (object) gameCommand);
                      }
                    }
                  }
                }
