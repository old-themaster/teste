...
// Type: Tank.Request.UserQuestList
  ...
  public class UserQuestList : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      try
      {
        ...
        {
          foreach (QuestDataInfo info in playerBussiness.GetUserQuest(userID))
            node.Add((object) FlashUtils.CreateQuestDataInfo(info));
          flag = true;
          str = "Success!";
        }
      }
      ...
      {
        UserQuestList.log.Error((object) nameof (UserQuestList), ex);
      }
