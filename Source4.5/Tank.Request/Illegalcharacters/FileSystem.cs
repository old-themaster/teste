...
// Type: Tank.Request.Illegalcharacters.FileSystem
...
namespace Tank.Request.Illegalcharacters
{
  public class FileSystem
  {
    ...
    private void OnChanged(object source, FileSystemEventArgs e) => this.UpdataContent();

    private void UpdataContent() => this.initContent(this.filePath);
