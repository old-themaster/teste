...
// Type: Tank.Request.ConsortiaApplyAllyList
  ...
  public class ConsortiaApplyAllyList : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      try
      {
        ...
        {
          foreach (ConsortiaApplyAllyInfo info in consortiaBussiness.GetConsortiaApplyAllyPage(page, size, ref total, order, consortiaID, applyID, state))
            node.Add((object) FlashUtils.CreateConsortiaApplyAllyInfo(info));
          flag = true;
          str = "Success!";
        }
      }
      ...
      {
        ConsortiaApplyAllyList.log.Error((object) nameof (ConsortiaApplyAllyList), ex);
      }
