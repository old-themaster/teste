...
namespace Game.Service.actions
{
    ...
    public class ConsoleStart:IAction
    {
        ...
        {
            Console.Title = "DDTank Wonder - Center Service 4.6.0 | Final";
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("Developed by : ASUNA & ALİTA");
            Console.WriteLine("Project Version 4.6.0 / Updated Time:10/05/2020");
            Console.WriteLine("www.wonder-games.com / www.facebook.com/ddtwondergames | All Rights Reserved.");
