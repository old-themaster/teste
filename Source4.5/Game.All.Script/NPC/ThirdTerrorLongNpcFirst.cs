...
namespace GameServerScript.AI.NPC
{
    public class ThirdTerrorLongNpcFirst : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcFirst.msg8"),
        };
        #endregion
    }
}
