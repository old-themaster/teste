...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenSimpleNioBoss : ABrain
	{
		...
		public ThirteenSimpleNioBoss()
		{
			...
			this.int_2 = 5000;
			this.int_3 = 15000;
			this.string_0 = new string[] { "Ataque Ataque. Que tipo de críticas?", "Oh, tão mágico. Lustre de sangue é tão bom", "Buff para cura, Ataque e terno..", "Derrotar-nos não é fácil. Me observe." };
