...
namespace GameServerScript.AI.NPC
{
    public class ThirdNormalShortNpcFirst : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg8"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcFirst.msg10")
        };
        #endregion
    }
}
