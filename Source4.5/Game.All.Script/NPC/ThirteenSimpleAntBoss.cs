...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenSimpleAntBoss : ABrain
	{
		...
		public ThirteenSimpleAntBoss()
		{
			...
			this.int_1 = 13002;
			this.string_0 = new string[] { "Tente aguenta esta minha flecha", "Veja se não está disponível", "Eu vou matar todos vocês", "Você acha que é o suficiente para me abaixar?." };
			this.UlosOgpdKaT = new string[] { "O broche de fita se soltou.", "Lamber meu broche de fita", "Deixe-me ajudá-lo a voltar ao céu rapidamente." };
		...
		private void method_0()
		{
			...
			if (base.Body.ShootPoint(this.m_targer.X, this.m_targer.Y, 0, 30, 51, 1000, 10000, 1, 3f, 2800))
			{
		...
		private void method_1()
		{
			...
			{
				if (base.Body.ShootPoint(playerArray[0].X - 20, playerArray[0].Y, 0, 30, 99, 1000, 10000, 1, 3f, 3000))
				{
					base.Body.PlayMovie("beatD", 1500, 3000);
				}
				if ((int)playerArray.Length == 2 && base.Body.ShootPoint(playerArray[1].X - 20, playerArray[1].Y, 0, 30, 99, 1000, 10000, 1, 3f, 5000))
				{
