...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenTerrorDevilBoss : ABrain
	{
		...
		private void LbQsAqcXidh()
		{
			...
			base.Body.MoveTo(this.m_targer.X, this.m_targer.Y, "fly", 1500, 10, new LivingCallBack(this.method_10));
		}
		...
		private void method_11()
		{
			...
			base.Body.MoveTo(num, num1, "fly", 1000, 10, new LivingCallBack(this.method_13));
		}
