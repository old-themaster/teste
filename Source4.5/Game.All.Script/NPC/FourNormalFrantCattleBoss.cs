    ...
    public class FourNormalFrantCattleBoss : ABrain
    {
            ...
            switch(m_attackTurn)
            {
                case 1:
                    if(!m_isBorn)
                    {
                        ...
                        Body.CallFuction(ClearOldBoss, 1000);
                        Body.Say("<span class=\"red\">Estou realmente com raiva. Vou esmagar todos!</span>", 0, 1200);
        ...
        private void JumpAttack()
        {
            ...
            if(m_targer != null)
            {
                ...
                else
                {
                    ...
                    Body.RangeAttacking(Body.X - 100, Body.X + 100, "cry", 5000, true);
                }
            }
        }
        ...
        private void RunAttack()
        {
            ...
            if(m_targer != null)
            {
                ...
                // check it's current
                if (Body.Distance(m_targer.X, m_targer.Y) <= 100)
                {
                ...
                {
                    if (Body.Direction == -1)
                        Body.MoveTo(m_targer.X - 20, m_targer.Y, "walk", 1000, AttackRangeRun, 12);
                    else
                        Body.MoveTo(m_targer.X + 20, m_targer.Y, "walk", 1000, AttackRangeRun, 12);
                }
            }
        ...
        private void ClearOldBoss()
        {
            foreach(SimpleBoss boss in Game.FindAllTurnBoss())
            {
        ...
        {
            base.OnDie();
            Body.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourNormalFrantCattleBoss.msg2"), 0, 1200);
        }
