...
namespace GameServerScript.AI.NPC
{
    public class ThirdSimpleLongNpcFirst : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcFirst.msg8"),
        };
        #endregion
    }
}
