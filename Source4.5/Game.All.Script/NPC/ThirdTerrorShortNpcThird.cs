...
namespace GameServerScript.AI.NPC
{
    public class ThirdTerrorShortNpcThird : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorShortNpcThird.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorShortNpcThird.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorShortNpcThird.msg3"),
        };
        #endregion
    }
}
