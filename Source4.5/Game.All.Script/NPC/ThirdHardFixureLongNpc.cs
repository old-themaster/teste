...
namespace GameServerScript.AI.NPC
{
    public class ThirdHardFixureLongNpc : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardFixureLongNpc.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardFixureLongNpc.msg2"),
        };
        #endregion
    }
}
