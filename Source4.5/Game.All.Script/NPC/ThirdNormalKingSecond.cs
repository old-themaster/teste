...
namespace GameServerScript.AI.NPC
{
    public class ThirdNormalKingSecond : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg10"),
        };
        private static string[] KillPlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg14"),
        };
        private static string[] KillAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg15"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg16"),
        };
        private static string[] SeePlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg11"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg12"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg13"),
        };
        private static string[] MoveChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg8"),
        };
        private static string[] HuffyPlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg17"),
        };
        ...
        public override void OnStartAttacking()
        {
            ...
            if ((Game as PVEGame).Param5 == 3)
            {
                ...
                if (bossCount < 2)
                {
                    ...
                    SimpleBoss boss = ((PVEGame)Game).CreateBoss(3114, 1300, 600, -1, 0);
                    boss.FallFrom(1300, 702, "fall", 0, 2, 1000);
                    boss.SetRelateDemagemRect(-12, -50, 23, 37);
                    boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalKingSecond.msg1"), 0, 2000, 5000);
                    boss.AddDelay(16);
