...
namespace GameServerScript.AI.NPC
{
    public class FourHardCattleBoss : ABrain
    {
        ...
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg3")
        };

        private string[] KillAttackSay =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg7")
        };

        private string[] AllAttackPlayerSay =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg8"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg10"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg11")
        };

        private string[] TiredSay =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg12"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg13"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg14")
        };

        private string[] FearSay =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg15"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg16"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg17")
        };

        private string[] OnShootedChat =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg18"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg19"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg20"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg21"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg22"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg23"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg24"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg25"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg26"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg27"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg28"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg29")
        };

        private string[] SpecialAttackSay =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg30"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg31"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg32"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg33")
        };

        private string[] DiedChat =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg34")
        };

        private string[] KillPlayerChat =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg35"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg36"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg37"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardCattleBoss.msg38")
        };
