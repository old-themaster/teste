...
namespace GameServerScript.AI.NPC
{
    public class HardKingLast : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg1")
        };

        private static string[] ShootChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg2"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg3"),
             
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg4"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg5"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg6")          
        };

        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg7")                          
        };

        private static string[] AngryChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg8")                          
        };

        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg9")                          
        };

        private static string[] SealChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg10")                          
        };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg11"),                  
 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg12")
        };

        private static string[] ShootedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg13"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg14"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg15")
        };

        private static string[] DiedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingLast.msg16")
        };
        ...
        public void GoOnAngger()
        {
            ...
            else
            {
                ...
                {
                    player.AddEffect(new ContinueReduceBloodEffect(2, 555, null), 0);
                }
            }
        }
