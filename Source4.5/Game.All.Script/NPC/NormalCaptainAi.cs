...
namespace GameServerScript.AI.NPC
{
    public class NormalCaptainAi : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg1"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg2"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg3")
        };

        private static string[] ShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg4"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg5")
        };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg6"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg7")
        };

        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg8"),
                  
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg9")
        };

        private static string[] JumpChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg10"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg11"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg12")
        };

        private static string[] KillAttackChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg13")
        };

        private static string[] KillChat = new string[]{
           LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg14"),

           LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg15")
        };

        private static string[] ShootedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg16"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg17")
        };

        private static string[] DiedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalCaptainAi.msg18")
        };
        #endregion
