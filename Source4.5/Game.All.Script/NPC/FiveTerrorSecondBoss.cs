    ...
    public class FiveTerrorSecondBoss : ABrain
    {
        ...
        public override void OnBeginNewTurn()
        {
            ...
            if (m_bottomNpc == null || m_centerNpc == null)
            {
                ...
                m_centerNpc = ((PVEGame)Game).CreateNpc(npcCenterId, 1546, 650, 0, -1, ((PVEGame)Game).BaseLivingConfig());
                m_centerNpc.Config.IsTurn = false;
                m_centerNpc.OnSmallMap(false);
                ((PVEGame)Game).SendHideBlood(m_centerNpc, 0);
