...
namespace GameServerScript.AI.NPC
{
    public class ThirdHardShortNpcFirst : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg8"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcFirst.msg10")
        };
        #endregion
    }
}
