...
{
    public class TwelveTerrorCrocodileBoss : ABrain
	{
		...
		private void CallBomb()
		{
            ...
            Body.Say("Сюда, верные слуги! Уничтожьте их!", 1, 1500);
        ...
        private void BeatA()
        {
            ...
            Body.Say("Я тебя с землей сровняю!", 1, 1000);
        ...
        private void BeatC()
        {
            randomPlayer = Game.FindRandomPlayer();
            Body.Direction = randomPlayer.X > Body.X ? 1 : -1;
            Body.Say("Скоро ты превратишья в решето.", 1, 1000);
        ...
        {
            Body.Direction = randomPlayer.X > Body.X ? 1 : -1;
            Body.Say("Ну-ну...давайте, покажите мне, на что вы способны!", 1, 100);
        ...
        { 
            randomPlayer = Game.FindRandomPlayer();
            Body.Direction = randomPlayer.X > Body.X ? 1 : -1;
            Body.Say("Думаешь мне нечем ответить?", 1, 100);
            Body.PlayMovie("beatD", 500, 2000);
