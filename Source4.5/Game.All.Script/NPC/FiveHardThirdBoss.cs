...
namespace GameServerScript.AI.NPC
{
    public class FiveHardThirdBoss : ABrain
    {
        ...
        private int m_npcId1 = 5222;

        private int m_npcId2 = 5223;

        private int m_npcId3 = 5224;

        private int m_countForzenCanKill = 2;
        ...
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg3")
        };

        private string[] CallNpc3Say =
        {
            "Quero torturar sem piedade <span class='red'>{0}</span>, sem piedade!", // GameServerScript.AI.NPC.FiveHardBossThird.msg4
            "<span class='red'>{0}</span>, já chegou a sua vez!", // GameServerScript.AI.NPC.FiveHardBossThird.msg5
            "Feche, quero fechar <span class='red'>{0}</span>!", // GameServerScript.AI.NPC.FiveHardBossThird.msg6
            "<span class='red'>{0}</span>, Veja isso", // GameServerScript.AI.NPC.FiveHardBossThird.msg7
            "Todo o mundo olhê, <span class='red'>{0}</span> já será executado." // GameServerScript.AI.NPC.FiveHardBossThird.msg8
        };

        private string[] GlobalAttackSay =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg10")
        };

        private string[] CallNpc1Say =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg11"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg12")
        };

        private string[] OnShootedChat =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg13"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg14"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg15")
        };

        private string[] KillPlayerChat =
        {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg16"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg17"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg18")
        };
