...
{
    public class ThirdSimpleLongNpcSecond : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleLongNpcSecond.msg8"),
        };
        #endregion
    }
}
