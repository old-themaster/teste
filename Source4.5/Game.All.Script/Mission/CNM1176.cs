...
namespace GameServerScript.AI.Messions
{
    public class CNM1176 : AMissionControl
    {
        ...
        public override void OnPrepareNewSession()
        {
            ...
            Game.SetMap(1076);
            Game.IsBossWar = LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1176.msg1");
        }
        ...
        public override bool CanGameOver()
        {
            ...
            if (m_state == secondBossID && m_secondKing == null)
            {
                ...
                m_secondKing.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1176.msg3"), 0, 3000);
            ...
            {
                Game.CreatePhysicalObj(m_secondKing.X, m_secondKing.Y, "king", "game.living.LivingRecover005", "0", 0, 0, 0);
                m_kill++;
                return true;
            }
        ...
        public override void OnGameOver()
        {
            ...
            loadingFileInfos.Add(new LoadingFileInfo(2, "image/map/1/show7.jpg", ""));
