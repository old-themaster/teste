...
{
    public class CPS7002 : AMissionControl
    {
        ...
        private void CreateEffectSaying()
        {
            ...
            m_king.Say("Por que você está aqui?", 0, 1500);
            Game.SendObjectFocus(boss, 1, 4000, 0);
            boss.PlayMovie("speak", 4500, 0);
            boss.Say("Não precisa saber. Destrua-os!", 0, 4500);
            Game.SendObjectFocus(king, 1, 8000, 0);
            king.PlayMovie("speak", 8500, 0);
            king.Say("Agora você fugiu no tempo.", 0, 8500, 10000);
        }
