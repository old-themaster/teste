...
{
    public class THSM3005 : AMissionControl
    {
        ...
        private int bossID = 3014;

        private int battleID = 3015;

        private int bloomID = 3007;
        ...
        public void CreateBoss()
        {
            ...
            guardBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.THSM3005.msg1"), 0, 1100, 5000);
            guardBoss.Degree = 1;
        ...
        public void CreateBloom()
        {
            ...
            bloom.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.THSM3005.msg2"), 0, 1500,3000);
