...
{
    public class DKT4303 : AMissionControl
    {
        ...
        private int bossID = 4308; // Minotaur

        private int bossID2 = 4309; // minotaur
        ...
        public override void OnStartGame()
        {
            ...
            m_king = Game.CreateBoss(bossID, 1255, 958, -1, 1, 0, "born", config);
        ...
        private void CreateBornKing2()
        {
            ...
            m_king2.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourTerrorFrantCattleBoss.msg1"), 0, 200);
        }
