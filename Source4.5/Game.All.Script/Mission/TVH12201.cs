...
{
    public class TVH12201 : AMissionControl
	{
		private List<SimpleNpc> npcList = new List<SimpleNpc>();

		private int BossID = 12203;

		private int BigVolverineNPC = 12202;

		private int VolverineNPC = 12201;

		private int ChickenHelp = 12204;
