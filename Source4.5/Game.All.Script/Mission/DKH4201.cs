...
{
    public class DKH4201 : AMissionControl
    {
        ...
        private int npcID2 = 4201; // bom hat nhan

        private int npcID = 4203; // cam tu quan

        private int bossID = 4204; // rong

        private int m_bloodReduce = 2000;

        private int m_totalNpc = 2;
        ...
        public override void OnStartGame()
        {
            ...
            m_boss = Game.CreateBoss(bossID, 1520, 350, -1, 0, 0, "", config);
        ...
        private void CreateHelper()
        {
            ...
            m_helper = Game.CreateBoss(npcID2, 321, 746, 1, 0, 0, "", config);
