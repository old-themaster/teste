...
namespace GameServerScript.AI.Messions
{
    public class DCR5101 : AMissionControl
    {
        ...
        private int npcId1 = 5102;

        private int npcId2 = 5103;

        private int helperId = 5104;
        ...
        public override void OnStartGame()
        {
            ...
            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFirst.msg1"), 0, 2000);
        ...
        private void CallActionEndGame()
        {
            ...
            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFirst.msg2"), 0, 1000);

            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFirst.msg3"), 0, 3000, 2000);
        }
