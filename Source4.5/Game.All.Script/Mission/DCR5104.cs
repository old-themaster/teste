...
namespace GameServerScript.AI.Messions
{
    public class DCR5104 : AMissionControl
    {
        ...
        private int npcHelperId1 = 5133;

        private int npcHelperId2 = 5134;
        ...
        private void CreateHelperNpc()
        {
            ...
            m_npcHelper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg1"), 0, 3000, 2000);
        }
