namespace Game.Logic
{
    public enum eEffectType
    {
        ...
        InvinciblyEffect = 11, // 0x0000000B
        ...
        AddGuardEquipEffect = 39, // 0x00000027
        ContinueReduceBlood = 40, // 0x00000028
        DamageEffect = 41, // 0x00000029
        GuardEffect = 42, // 0x0000002A
        AddDamageTurnEffect = 43, // 0x0000002B
        AddGuardTurnEffect = 44, // 0x0000002C
        AddTargetEffect = 45, // 0x0000002D
        PhongAn = 1000, // 0x000003E8
        ContinueReduceGreenBloodEffect = 1001, // 0x000003E9
    }
}
