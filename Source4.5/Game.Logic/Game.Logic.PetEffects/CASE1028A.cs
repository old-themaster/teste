...
{
    public class CASE1028A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1028A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1028A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1028A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1028A) as CASE1028A;
            if (cE != null)
            {
