...
// Type: Game.Logic.PetEffects.PetMakeDamageEquipEffect
...
namespace Game.Logic.PetEffects
{
  public class PetMakeDamageEquipEffect : BasePetEffect
  {
    ...
    public PetMakeDamageEquipEffect(
      int count,
      int probability,
      int type,
      int skillId,
      int delay,
      string elementID)
      : base(ePetEffectType.PetMakeDamageEquipEffect, elementID)
    {
    ...
    private void player_AfterKilledByLiving(Living living)
    {
      ...
      new PetMakeDamageEquip(this.m_count, this.m_currentId, this.Info.ID.ToString()).Start(living);
    }
