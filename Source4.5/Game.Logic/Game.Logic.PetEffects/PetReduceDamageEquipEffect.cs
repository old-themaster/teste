...
// Type: Game.Logic.PetEffects.PetReduceDamageEquipEffect
...
namespace Game.Logic.PetEffects
{
  public class PetReduceDamageEquipEffect : BasePetEffect
  {
    ...
    public PetReduceDamageEquipEffect(
      int count,
      int probability,
      int type,
      int skillId,
      int delay,
      string elementID)
      : base(ePetEffectType.PetReduceDamageEquipEffect, elementID)
    {
      this.m_count = count;
    ...
    private void player_AfterKilledByLiving(Living living)
    {
      ...
      new PetReduceDamageEquip(this.m_count, this.m_currentId, this.Info.ID.ToString()).Start(living);
    }
