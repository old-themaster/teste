...
// Type: Game.Logic.PetEffects.PetReduceBloodAllBattleEquipEffectcs
...
namespace Game.Logic.PetEffects
{
  public class PetReduceBloodAllBattleEquipEffectcs : BasePetEffect
  {
    ...
    public PetReduceBloodAllBattleEquipEffectcs(
      int count,
      int probability,
      int type,
      int skillId,
      int delay,
      string elementID)
      : base(ePetEffectType.PetReduceBloodAllBattleEquipEffectcs, elementID)
    {
      this.m_count = count;
    ...
    private void player_AfterKilledByLiving(Living living)
    {
      ...
      new PetReduceBloodAllBattleEquip(this.m_count, this.m_currentId, this.Info.ID.ToString()).Start(living);
    }
