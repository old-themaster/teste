    ...
    public static class KeyCheck
    {
        ...
        private static Boolean VerificaKey(String key, String version, String ip, int rand)
        {
            try
            {
                ...
                byte[] responsebytes = client.UploadValues("https://ddtankorigens.com.br/key", "POST", reqparm);
...

        {
            ...
            byte[] inputBytes = System.Text.Encoding.ASCII.GetBytes(input + "DDtank Origens");
