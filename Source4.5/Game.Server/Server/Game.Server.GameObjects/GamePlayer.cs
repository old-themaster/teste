    ...
    public bool Login()
    {
        ...
        try
        {
            if (this.LoadFromDatabase())
            {
                ...
                Out.SendAcademySystemNotice("Bem vindo ao DDTank Official.", true);
                ...
                {
                    WorldMgr.SendSysNotice(string.Concat(" O Top 1 do Hall da Fama [", this.PlayerCharacter.NickName, "] entrou no jogo. Sua força de combate é: ", this.PlayerCharacter.FightPower, " da Guilda: ", this.PlayerCharacter.ConsortiaName));
                }
                GameServer.Instance.LoginServer.SendGetLightriddleInfo(iD);
