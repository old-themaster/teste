...
namespace Game.Server.GameUtils
{
  public abstract class CardAbstractInventory
  {
    ...
    public int BeginSlot => this.int_1;

    public int Capalility
    {
      get => this.int_0;
      set => this.int_0 = value < 0 ? 0 : (value > this.m_cards.Length ? this.m_cards.Length : value);
    }

    public bool IsEmpty(int slot) => slot < 0 || slot >= this.int_0 || this.m_cards[slot] == null;
    ...
    public virtual void UpdateCard(UsersCardInfo card) => this.OnPlaceChanged(card.Place);
    ...
    public bool AddCard(UsersCardInfo card) => this.AddCard(card, this.int_1);
    ...
    public virtual bool RemoveCardAt(int place) => this.RemoveCard(this.GetItemAt(place));
    ...
    public bool IsSolt(int slot) => slot >= 0 && slot < this.int_0;
    ...
    public virtual UsersCardInfo GetItemAt(int slot) => slot >= 0 && slot < this.int_0 ? this.m_cards[slot] : (UsersCardInfo) null;
    ...
    public int FindFirstEmptySlot() => this.FindFirstEmptySlot(this.int_1);
    ...
    public virtual UsersCardInfo GetItemByTemplateID(int templateId) => this.GetItemByTemplateID(this.int_1, templateId);
    ...
    public virtual List<UsersCardInfo> GetCards() => this.GetCards(0, this.int_0 - 1);
    ...
    public int GetEmptyCount() => this.GetEmptyCount(this.int_1);
    ...
    public void BeginChanges() => Interlocked.Increment(ref this.int_2);
