  ...
  public class PropSellHandler : IPacketHandler
  {
    public int HandlePacket(GameClient client, GSPacketIn packet)
    {
      ...
      if (itemAt != null)
      {
        ...
        ShopMgr.SetItemType(ShopMgr.GetShopItemInfoById(ID), type, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref num, ref num, ref hardCurrency, ref LeagueMoney, ref num);
