...
namespace Game.Server.Managers
{
    public class AwardMgr
  {
    ...
    public static List<DailyAwardInfo> dailyawards;    
        ...
        public static bool AddSignAwards(GamePlayer player, int DailyLog)
    {
      ...
      return flag3;
        ...
        public static List<DailyAwardInfo> FindReward(int getway)
        {
            return dailyawards.FindAll((DailyAwardInfo q) => q.GetWay == getway);
        }
    ...
    public static SearchGoodsTempInfo GetSearchGoodsTempInfo(int starId)
    {
      ...
      return (SearchGoodsTempInfo) null;
        ...
        public static void LoadFriendRewards()
        {
            ProduceBussiness produceBussiness = new ProduceBussiness();
            dailyawards = produceBussiness.GetAllDailyAward().ToList();
        }
    ...
    public static int MaxStar() => AwardMgr._searchGoodsTemp.Count;
    ...
    {
      get => AwardMgr._dailyAwardState;
      set => AwardMgr._dailyAwardState = value;
    }
  }
}
