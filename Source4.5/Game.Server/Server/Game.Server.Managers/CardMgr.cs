...
namespace Game.Server.Managers
{
  public class CardMgr
  {
    ...
    public static CardUpdateConditionInfo GetCardUpdateCondition(int level) => CardMgr.dictionary_0.ContainsKey(level) ? CardMgr.dictionary_0[level] : (CardUpdateConditionInfo) null;
    ...
    public static int MaxLevel() => CardMgr.dictionary_0.Count;
  }
}
