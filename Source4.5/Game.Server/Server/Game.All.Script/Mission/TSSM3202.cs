...
{
    public class TSSM3202 : AMissionControl
    {
        ...
        private int[] npcIDs = { 3202, 3205 };

        private int bloomIDs = 3207;

        private int bossID = 3219;
        ...
        public override void OnPrepareNewGame()
        {
            ...
            boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TSSM3202.msg3"), 0, 2000, 3000);
        ...
        public void CreateBloomNpc()
        {
            ...
            bloomNpc.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TSSM3202.msg1"), 0, 1500, 3000);
        ...
        public override bool CanGameOver()
        {
            ...
            if (bloomNpc.Blood == bloomNpc.MaxBlood)
            {
                ...
                bloomNpc.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TSSM3202.msg2"), 0, 1500, 0);
