...
namespace GameServerScript.AI.Messions
{
    public class CSM1076 : AMissionControl
    {
        ...
        public override void OnPrepareNewSession()
        {
            ...
            Game.SetMap(1076);
            Game.IsBossWar = LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1076.msg1");
        }
        ...
        public override bool CanGameOver()
        {
            ...
            if (m_state == secondBossID && m_secondKing == null)
            {
                ...
                m_secondKing.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1076.msg3"), 0, 3000);
