...
{
    public class TSSM3206 : AMissionControl
    {
        ...
        private int bloomID = 3213;

        private int npcID = 3203;

        private int blownpcID = 3212;

        private int bloomSnpcID = 3218;
        ...
        public override void OnPrepareNewGame()
        {
            ...
            firstBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TSSM3206.msg1"), 0, 3000);
