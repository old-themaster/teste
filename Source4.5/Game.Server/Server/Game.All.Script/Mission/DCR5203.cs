...
namespace GameServerScript.AI.Messions
{
    public class DCR5203 : AMissionControl
    {
        ...
        private int npcId1 = 5222;

        private int npcId2 = 5223;

        private int npcId3 = 5224;

        private int npcId4 = 5204;
        ...
        public override void OnStartGame()
        {
            ...
            m_boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg1"), 0, 1000);
        ...
        private void CreateEffectEndGame()
        {
            ...
            m_tempBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardBossThird.msg19"), 0, 1000);
        ...
        private void CreateNpcEndGame()
        {
            ...
            npc.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardElderThird.msg1"), 0, 4000, 2000);
