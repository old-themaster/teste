...
{
    public class TVN12102 : AMissionControl
	{
		private static string[] string_0 = new string[] { "Không có gì phải sợ, đau đớn sẻ qua", "Kẻ tầm thường và thấp hèn." };

		private static string[] string_1 = new string[] { "Chỉ được vậy thôi à ?…", "Sức mạnh cũng thường…" };

		private int BossID = 12108;

		private int HelperNPCID = 12106;

		private int cannonball = 12107;
