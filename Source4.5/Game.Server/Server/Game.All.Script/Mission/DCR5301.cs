...
namespace GameServerScript.AI.Messions
{
    public class DCR5301 : AMissionControl
    {
        ...
        private int npcId1 = 5302;

        private int npcId2 = 5303;

        private int helperId = 5304;
        ...
        public override void OnPrepareNewSession()
        {
            ...
            Game.AddLoadingFile(2, "image/game/effect/5/zap2.swf", "asset.game.4.zap2");
            Game.AddLoadingFile(2, "image/game/effect/5/dian.swf", "asset.game.4.dian");
        ...
        public override void OnStartGame()
        {
            ...
            m_boss = Game.CreateBoss(bossId, 1484, 750, -1, 1, 0, "born", config);
            ...
            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveTerrorElderFirst.msg1"), 0, 2000);
            m_helper.MoveTo(1388, 867, "walk", 4000, new LivingCallBack(StepAfterWalk));
        }
        ...
        private void CreateProtectNpc()
        {
            ...
            m_npc = Game.CreateNpc(npcId1, 187, 370, 0, 1, config);
        ...
        private void CallActionEndGame()
        {
            ...
            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveTerrorElderFirst.msg2"), 0, 1000);

            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveTerrorElderFirst.msg3"), 0, 3000, 2000);
        }
