...
namespace GameServerScript.AI.Messions
{
    public class DCR5201 : AMissionControl
    {
        ...
        private int npcId1 = 5202;

        private int npcId2 = 5203;

        private int helperId = 5204;
        ...
        public override void OnStartGame()
        {
            ...
            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardElderFirst.msg1"), 0, 2000);
        ...
        private void CallActionEndGame()
        {
            ...
            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardElderFirst.msg2"), 0, 1000);

            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveHardElderFirst.msg3"), 0, 3000, 2000);
        }
