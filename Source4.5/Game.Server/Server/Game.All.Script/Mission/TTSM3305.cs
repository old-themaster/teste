...
{
    public class TTSM3305 : AMissionControl
    {
        ...
        private int bossID = 3314;

        private int battleID = 3315;

        private int bloomID = 3307;
        ...
        public void CreateBoss()
        {
            ...
            guardBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TTSM3305.msg1"), 0, 1100, 5000);
            guardBoss.Degree = 1;
        ...
        public void CreateBloom()
        {
            ...
            bloom.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TTSM3305.msg2"), 0, 1500,3000);
