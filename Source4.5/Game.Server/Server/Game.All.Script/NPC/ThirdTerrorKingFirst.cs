...
namespace GameServerScript.AI.NPC
{
    public class ThirdTerrorKingFirst : ABrain
    {
        ...
        private int lockTotemID = 3311;

        private int FagTotemID = 3310;
        ...
        private static string[] AllAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg4"),
        };

        private static string[] TwiceShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg31"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg32"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg33"),
        };

        private static string[] ThriceShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg29"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg30"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg33"),
        };

        private static string[] AddBooldChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg13"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg14"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg15"),
        };

        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg16"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg17"),
        };

        private static string[] AddEstateChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg18"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg19"),
        };

        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg6"),
        };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg26"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg27"),
        };

        private static string[] LockTotemChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg8"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg9"),
        };

        private static string[] FagTotemChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg10"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg11"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg12"),
        };

        private static string[] ShootedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg28"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg281"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg282"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg283"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg284"),
        };

        private static string[] ReliveChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg20"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg21"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg22"), 
        };

        private static string[] ReliveThankChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg23"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg24"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingFirst.msg25"),
        };
        ...
        private void PersonalAttack()
        {
            ...
            if (rand == 0)
            {
                int index = Game.Random.Next(0, TwiceShootChat.Length);
                Body.Say(TwiceShootChat[index], 1, 0);
                Body.CurrentDamagePlus = 0.7f;
                TwiceAttack(target, 1900, 1500);
                TwiceAttack(target, 3400, 3000);
            }
            else
            {
                int index = Game.Random.Next(0, ThriceShootChat.Length);
                Body.Say(ThriceShootChat[index], 1, 0);
                Body.CurrentDamagePlus = 0.8f;
                ThriceAttack(target);
            }
        }

        private void TwiceAttack(Player player, int ShootDelay, int MovieDelay)
        {
            if (player.X > Body.X)
            {
                Body.ChangeDirection(1, MovieDelay - 1500);
            }
            else
            {
                Body.ChangeDirection(-1, MovieDelay - 1500);
            ...
            if (Body.ShootPoint(mtX, player.Y, 54, 1000, 10000, 1, 1.0f, ShootDelay))
            {
                Body.PlayMovie("beatA", MovieDelay, 0);
            }
        }

        private void ThriceAttack(Player player)
        {
            if (player != null)
            {
                if (player.X > Body.X)
                ...
                if (Body.ShootPoint(mtX, player.Y, 54, 1000, 10000, 3, 1, 1900))
                {
