...
namespace GameServerScript.AI.NPC
{
    public class ThirdHardKingSecond : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg10"),
        };
        private static string[] KillPlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg14"),
        };
        private static string[] KillAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg15"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg16"),
        };
        private static string[] SeePlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg11"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg12"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg13"),
        };
        private static string[] MoveChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg8"),
        };
        private static string[] HuffyPlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg17"),
        };
        ...
        public override void OnStartAttacking()
        {
            ...
            if ((Game as PVEGame).Param5 == 3)
            {
                ...
                if (bossCount < 2)
                {
                    ...
                    SimpleBoss boss = ((PVEGame)Game).CreateBoss(3214, 1300, 600, -1, 0);
                    boss.FallFrom(1300, 702, "fall", 0, 2, 1000);
                    boss.SetRelateDemagemRect(-12, -50, 23, 37);
                    boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingSecond.msg1"), 0, 2000, 5000);
                    boss.AddDelay(16);
