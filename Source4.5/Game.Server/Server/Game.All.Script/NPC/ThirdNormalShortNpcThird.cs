    ...
    public class ThirdNormalShortNpcThird : ABrain
    {
        ...
        public void MoveToPlayer()
        {
            ...
            if (dis > 60)
            {
                ...
                //Console.WriteLine("怪物的X坐标是{0},玩家的X坐标是{1},dis是{2}", Body.X, attack.X, dis);
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcThird.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcThird.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalShortNpcThird.msg3"),
        };
        #endregion
    }
}
