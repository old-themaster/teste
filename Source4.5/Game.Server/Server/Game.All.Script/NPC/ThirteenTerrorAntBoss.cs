...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenTerrorAntBoss : ABrain
	{
		...
		public ThirteenTerrorAntBoss()
		{
			...
			this.int_0 = 13302;
			this.string_0 = new string[] { "Tente lamber esta minha flecha", "Veja se não está disponível", "Eu vou matar todos vocês", "Você acha que é o suficiente para me abaixar?." };
			this.string_1 = new string[] { "O broche de fita se soltou.", "Lamber meu broche de fita", "Deixe-me ajudá-lo a voltar ao céu rapidamente." };
