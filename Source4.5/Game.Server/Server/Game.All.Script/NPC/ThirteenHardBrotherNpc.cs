...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenHardBrotherNpc : ABrain
	{
		...
		private void method_0()
		{
			...
			base.Body.Say("Grande Deus do mal, dê sua força para nós!", 1, 1000);
			...
			else
			{
				...
				this.simpleBoss_0.Say("O que há Sacrifício está errado cmnr.", 0, 10500, 2000);
		...
		private void method_2()
		{
			...
			base.Body.Say("O sacrifício está prestes a começar! Teremos o poder dos espíritos malignos! Lutando...", 1, 1000);
