...
namespace GameServerScript.AI.NPC
{
    public class FiveNormalFourNpc1 : ABrain
    {
        ...
        private int m_bossId = 5131;

        private int m_helperId = 5134;

        private static string[] HelpAttackSay = new string[] {
                    LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg2"),
                    LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg3"),
                    LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg4")
                };

        private static string[] AttackBossSay = new string[] {
                    LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg5"),
                    LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg6"),
                    LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg7"),
                    LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderFour.msg7")
                };
