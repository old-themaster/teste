...
namespace GameServerScript.AI.NPC
{
    public class ThirdHardKingFour : ABrain
    {
        ...
        private static string[] AllBakeChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg1"),
        };
        private static string[] BurningChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg2"),
        };
        private static string[] ShootChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg6"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg7"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg8"),
        };
        private static string[] KillAttackChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg21"),
        };
        private static string[] AllAttackChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg3"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg4"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg5"),
        };
        private static string[] AllCarryChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg9"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg10"),
        };
        private static string[] KillBloomChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg11"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg12"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg13"),
        };
        private static string[] KillPlayerChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg14"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg15"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg16"),
        };
        private static string[] DieChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg17"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg18"),
        };
        private static string[] ShooteChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg20"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg201"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg202"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg203"),
        };
        private static string[] BloomReliveChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardBloomNpcS.msg6"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardBloomNpcS.msg7"),
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardBloomNpcS.msg8"),
        };
        ...
        private void BakeAttack()
        {
            ...
            foreach (Player player in players)
            {
                if (player.IsLiving)
                {
                    player.AddEffect(new ContinueReduceBloodEffect(3, 500, null), 0);
        ...
        private void CreateBloomS()
        {
            ...
            if (m_bloomCreateDir == 0)
            {
                ...
                if (m_isSay == 0)
                {
                    ...
                    m_Bloom.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFour.msg19"), 0, 2000, 3000);
                }
                else
                {
