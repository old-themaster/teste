...
namespace GameServerScript.AI.NPC
{
    public class ThirdHardShortNpcThird : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcThird.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcThird.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardShortNpcThird.msg3"),
        };
        #endregion
    }
}
