...
namespace GameServerScript.AI.NPC
{
    public class FourTerrorWolfNpc : ABrain
    {
        ...
        private int friendlyNpcId = 4305;
        ...
        private void RandomMove()
        {
            ...
            Body.MoveTo(Body.X + dismove, Body.Y, "walkA", 3500, NothingAction);
        }
        ...
        private void FindRandomPlayer()
        {
            ...
            if (m_targetPlayer != null)
            {
                ...
                Body.Say(string.Format(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourTerrorWolfNpc.msg1", m_targetPlayer.PlayerDetail.PlayerCharacter.NickName)), 0, 2000, 0);
        ...
        private void RunToTargetPlayer()
        {
            ...
            if (dis > 600)
                Body.MoveTo(m_targetPlayer.X, m_targetPlayer.Y, "walkB", 2200, BeatTargetPlayer, 10);
            else
                Body.MoveTo(m_targetPlayer.X, m_targetPlayer.Y, "walkC", 2200, BeatTargetPlayer, 5);
        }
