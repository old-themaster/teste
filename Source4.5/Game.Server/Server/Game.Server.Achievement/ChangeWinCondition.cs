...
// Type: Game.Server.Achievement.ChangeWinCondition
...
namespace Game.Server.Achievement
{
    public class ChangeWinCondition : BaseUserRecord
  {
    ...
    private void player_PlayerPropertyChanged(PlayerInfo character) => this.m_player.AchievementInventory.UpdateUserAchievement(this.m_type, character.Win, 1);
