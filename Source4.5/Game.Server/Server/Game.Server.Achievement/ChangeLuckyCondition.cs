...
// Type: Game.Server.Achievement.ChangeLuckyCondition
...
namespace Game.Server.Achievement
{
    public class ChangeLuckyCondition : BaseUserRecord
  {
    ...
    private void player_PlayerPropertyChanged(PlayerInfo character) => this.m_player.AchievementInventory.UpdateUserAchievement(this.m_type, character.Luck, 1);
