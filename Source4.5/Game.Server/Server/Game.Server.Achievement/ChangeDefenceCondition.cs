...
namespace Game.Server.Achievement
{
    public class ChangeDefenceCondition : BaseUserRecord
  {
    ...
    private void player_PlayerPropertyChanged(PlayerInfo character) => this.m_player.AchievementInventory.UpdateUserAchievement(this.m_type, character.Defence, 1);
