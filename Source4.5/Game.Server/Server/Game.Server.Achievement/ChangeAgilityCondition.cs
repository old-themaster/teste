...
// Type: Game.Server.Achievement.ChangeAgilityCondition
...
namespace Game.Server.Achievement
{
    public class ChangeAgilityCondition : BaseUserRecord
  {
    ...
    private void player_PlayerPropertyChanged(PlayerInfo character) => this.m_player.AchievementInventory.UpdateUserAchievement(this.m_type, character.Agility, 1);
