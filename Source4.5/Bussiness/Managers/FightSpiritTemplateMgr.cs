...
namespace Bussiness.Managers
{
    public class FightSpiritTemplateMgr
    {
        ...
        private static Dictionary<int, List<FightSpiritTemplateInfo>> dictionary_0 = new Dictionary<int, List<FightSpiritTemplateInfo>>();
        ...
        public static List<FightSpiritTemplateInfo> FindFightSpiritTemplates(
          int id)
        {
        ...
        public static FightSpiritTemplateInfo FindFightSpiritTemplateInfo(
          int FigSpiritId,
          int lv)
        {
          ...
          ref int rdcDama)
        {
            ...
            if (spiritTemplateInfo == null)
            {
                ...
                if (fightSpiritTemplates.Count > 0)
                {
                    ...
                    FightSpiritTemplateMgr.ilog_0.ErrorFormat("FigSpiritId: {0}, level: {1} não encontrado! O nível máximo de retorno no banco de dados é {2}", (object)figSpiritId, (object)lv, (object)spiritTemplateInfo.Level);
                }
                else
                {
                    FightSpiritTemplateMgr.ilog_0.ErrorFormat("FigSpiritId: {0} não encontrado! Retorna 0", (object) figSpiritId);
                    return 0;
                }
            }
