...
namespace Bussiness.Managers
{
  public class ConsortiaExtraMgr
  {
    ...
    public static ConsortiaBadgeConfigInfo FindConsortiaBadgeConfig(int id) => ConsortiaExtraMgr.dictionary_3.ContainsKey(id) ? ConsortiaExtraMgr.dictionary_3[id] : (ConsortiaBadgeConfigInfo) null;
