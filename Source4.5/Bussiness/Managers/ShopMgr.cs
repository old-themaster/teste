...
namespace Bussiness.Managers
{
  public static class ShopMgr
  {
    ...
    public static bool CheckInShopGoodsCanBuy(int iTemplateID) => ShopMgr.m_ShopGoodsCanBuy.ContainsKey(iTemplateID);

    public static int FindItemTemplateID(int id) => ShopMgr.m_shop.ContainsKey(id) ? ShopMgr.m_shop[id].TemplateID : 0;
    ...
    public static ShopItemInfo GetShopItemInfoById(int ID) => ShopMgr.m_shop.ContainsKey(ID) ? ShopMgr.m_shop[ID] : (ShopItemInfo) null;
      ...
      ref int useableScore)
    {
      if (type == 1)
      {
        ShopMgr.GetItemPrice(shop.APrice1, shop.AValue1, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
        ShopMgr.GetItemPrice(shop.APrice2, shop.AValue2, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
        ShopMgr.GetItemPrice(shop.APrice3, shop.AValue3, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
      }
      if (type == 2)
      {
        ShopMgr.GetItemPrice(shop.BPrice1, shop.BValue1, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
        ShopMgr.GetItemPrice(shop.BPrice2, shop.BValue2, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
        ShopMgr.GetItemPrice(shop.BPrice3, shop.BValue3, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
      }
      if (type == 3)
      {
        ShopMgr.GetItemPrice(shop.CPrice1, shop.CValue1, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
        ShopMgr.GetItemPrice(shop.CPrice2, shop.CValue2, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
        ShopMgr.GetItemPrice(shop.CPrice3, shop.CValue3, shop.Beat, ref damageScore, ref petScore, ref iTemplateID, ref iCount, ref gold, ref money, ref offer, ref gifttoken, ref medal, ref Ascension, ref hardCurrency, ref LeagueMoney, ref useableScore);
      }
      return true;
    }
  }
