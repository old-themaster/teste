...
namespace Bussiness
{
    public class ConsortiaBussiness : BaseBussiness
    {
        ...
        {
            List<ConsortiaAllyInfo> consortiaAllyInfoList = new List<ConsortiaAllyInfo>();
            string queryWhere = " IsExist=1 and ConsortiaID<>" + consortiaID.ToString();
          ...
          int state)
        {
            ...
            try
            {
                ...
                if (consortiaID != -1)
                    queryWhere = queryWhere + " and Consortia2ID =" + consortiaID.ToString() + " ";
                if (applyID != -1)
                    queryWhere = queryWhere + " and ID =" + applyID.ToString() + " ";
                if (state != -1)
                    queryWhere = queryWhere + " and State =" + state.ToString() + " ";
          ...
          int userID)
        {
            ...
            try
            {
                string queryWhere = " IsExist=1 ";
                if (consortiaID != -1)
                    queryWhere = queryWhere + " and ConsortiaID =" + consortiaID.ToString() + " ";
                if (applyID != -1)
                    queryWhere = queryWhere + " and ID =" + applyID.ToString() + " ";
                if (userID != -1)
          ...
          int dutyID)
        {
            ...
            try
            {
                ...
                if (consortiaID != -1)
                    queryWhere = queryWhere + " and ConsortiaID =" + consortiaID.ToString() + " ";
                if (dutyID != -1)
                    queryWhere = queryWhere + " and DutyID =" + dutyID.ToString() + " ";
                string str = "Level";
                if (order == 1)
                    str = "DutyName";
          ...
          int type)
        {
            ...
            try
            {
                ...
                if (consortiaID != -1)
                    queryWhere = queryWhere + " and ConsortiaID =" + consortiaID.ToString() + " ";
                if (level != -1)
                    queryWhere = queryWhere + " and Level =" + level.ToString() + " ";
                if (type != -1)
                    queryWhere = queryWhere + " and Type =" + type.ToString() + " ";
          ...
          int inviteID)
        {
            ...
            try
            {
                ...
                if (userID != -1)
                    queryWhere = queryWhere + " and UserID =" + userID.ToString() + " ";
                if (inviteID != -1)
                    queryWhere = queryWhere + " and UserID =" + inviteID.ToString() + " ";
                string str = "ConsortiaName";
                switch (order)
                {
                    case 1:
          ...
          int openApply)
        {
            ...
            try
            {
                ...
                if (level != -1)
                    queryWhere = queryWhere + " and Level =" + level.ToString() + " ";
                if (openApply != -1)
                    queryWhere = queryWhere + " and OpenApply =" + openApply.ToString() + " ";
                string str = "ConsortiaName";
                switch (order)
                {
                    case 1:
          ...
          new SqlParameter("@ID", (object) id)
                ...
                if (ResultDataReader.Read())
                    return new ConsortiaInfo()
                    {
                        ...
                        //LastOpenBoss = (DateTime)ResultDataReader["LastOpenBoss"],
