  ...
  public class ProduceBussiness : BaseCrossBussiness
  {
    public ActiveAwardInfo[] GetAllActiveAwardInfo()
    {
      ...
      return activeAwardInfoList.ToArray();
        ...
        public DiceLevelAwardInfo[] GetDiceLevelAwardInfos()
        {
            ...
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)"GetAllDiceLevelAward", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
        ...
        public TreeTemplateInfo[] GetAllTreeTemplate()
        {
            ...
            try
            {
                this.db.GetReader(ref ResultDataReader, "SP_Get_AllTreeTemplate");
                while (ResultDataReader.Read())
                {
                    TreeTemplateInfo treeTemplateInfo = new TreeTemplateInfo()
                    {
                        ...
                        MosterID = (int)ResultDataReader["MosterID"],
                        MosterName = (string)ResultDataReader["MosterName"],
                        Exp = (int)ResultDataReader["Exp"]
                    };
                    treeTemplateInfoList.Add(treeTemplateInfo);
                }
            }
            catch (Exception ex)
            {
                if (log.IsErrorEnabled)
                    log.Error((object)"TreeTemplateInfo", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
        ...
        public NewTitleInfo InitNewTitleInfo(SqlDataReader dr) => new NewTitleInfo()
        {
            ID = (int)dr["ID"],
            Show = (int)dr["Show"],
            Name = (string)dr["Name"],
        ...
        {
            List<MysteryShopInfo> infos = new List<MysteryShopInfo>();
            SqlDataReader reader = null;
            try
            {
                db.GetReader(ref reader, "SP_Mystery_Shop_Items_All");
                while (reader.Read())
                {
                    infos.Add(InitMysteryShopInfo(reader));
                }
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("InitMysteryShopInfo", e);
            }
            finally
            {
        ...
        {
            MysteryShopInfo info = new MysteryShopInfo();
            info.ID = (int)dr["ID"];
            info.LableType = (int)dr["LableType"];
            info.InfoID = (int)dr["InfoID"];
            info.Unit = (int)dr["Unit"];
            info.Num = (int)dr["Num"];
            info.Price = (int)dr["Price"];
            info.CanBuy = (int)dr["CanBuy"];
            info.Random = (int)dr["Random"];
            return info;
        }

        public NewTitleInfo[] GetAllNewTitle()
        {
            List<NewTitleInfo> newTitleInfos = new List<NewTitleInfo>();
            ...
            try
            {
                try
                {
                    ...
                    {
                        newTitleInfos.Add(this.InitNewTitleInfo(sqlDataReader));
                    }
                }
                catch (Exception exception1)
                {
                    ...
                    if (this.log.IsErrorEnabled)
                    {
                        this.log.Error("InitNewTitleInfo", exception);
                    }
                }
            }
            finally
        ...
        public ActivitySystemItemInfo[] GetAllActivitySystemItem()
        {
            ...
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)nameof(GetAllActivitySystemItem), ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
        ...
        public ActiveConditionInfo[] GetAllActiveConditionInfo()
    {
      ...
      return activeConditionInfoList.ToArray();
        ...
        public AsunaAwardInfo[] GetAsunaAwardInfos()
        {
            List<AsunaAwardInfo> infos = new List<AsunaAwardInfo>();
            SqlDataReader reader = null;
            try
            {
                this.db.GetReader(ref reader, "SP_AsunaAwardItem_All");
                while (reader.Read())
                {
                    infos.Add(new AsunaAwardInfo
                    {
                        ID = (int)reader["ID"],
            ...
            catch (Exception e)
            {
                if (this.log.IsErrorEnabled)
                {
                    this.log.Error("GetAllAsunaAward", e);
                }
            }
            finally
            {
        ...
        public GodcardlistgroupCard[] Get_GodcardlistgroupCard()
        {
            List<GodcardlistgroupCard> godcardlistgroupCardList = new List<GodcardlistgroupCard>();
            SqlDataReader ResultDataReader = (SqlDataReader)null;
            try
            {
                this.db.GetReader(ref ResultDataReader, "SP_GodcardlistgroupCard");
                while (ResultDataReader.Read())
                {
                    GodcardlistgroupCard godcardlistgroupCard = new GodcardlistgroupCard()
                    {
                        GroupID = (int)ResultDataReader["GroupID"],
                        CardID = (int)ResultDataReader["CardID"],
                        Number = (int)ResultDataReader["Number"]
                    };
        ...
        public Godcardlist[] Get_Godcardlist()
        {
            List<Godcardlist> godcardlistList = new List<Godcardlist>();
            SqlDataReader ResultDataReader = (SqlDataReader)null;
            try
            {
                this.db.GetReader(ref ResultDataReader, "SP_Godcardlist");
                while (ResultDataReader.Read())
                {
                    Godcardlist godcardlist = new Godcardlist()
                    {
                        ID = (int)ResultDataReader["ID"],
                        Name = (string)ResultDataReader["Name"],
                        Pic = (int)ResultDataReader["Pic"],
                        Composition = (int)ResultDataReader["Composition"],
                        Decompose = (int)ResultDataReader["Decompose"],
                        Level = (int)ResultDataReader["Level"]
                    };
                    godcardlistList.Add(godcardlist);
                }
            }
            catch (Exception ex)
            {
            ...
            return godcardlistList.ToArray();
        }

        public Godcardlistgroup[] Get_Godcardlistgroup()
        {
            List<Godcardlistgroup> godcardlistgroupList = new List<Godcardlistgroup>();
            SqlDataReader ResultDataReader = (SqlDataReader)null;
            try
            {
                this.db.GetReader(ref ResultDataReader, "SP_Godcardlistgroup");
                while (ResultDataReader.Read())
                {
                    Godcardlistgroup godcardlistgroup = new Godcardlistgroup()
                    {
                        GroupID = (int)ResultDataReader["GroupID"],
                        GroupName = (string)ResultDataReader["GroupName"],
                        ExchangeTimes = (int)ResultDataReader["ExchangeTimes"],
                        GiftID = (int)ResultDataReader["GiftID"]
                    };
                    godcardlistgroupList.Add(godcardlistgroup);
                }
            }
            catch (Exception ex)
            {
            ...
            return godcardlistgroupList.ToArray();
        }

        public Godcardpointrewardlist[] Get_Godcardpointrewardlist()
        {
            List<Godcardpointrewardlist> godcardpointrewardlistList = new List<Godcardpointrewardlist>();
            SqlDataReader ResultDataReader = (SqlDataReader)null;
            try
            {
                this.db.GetReader(ref ResultDataReader, "SP_Godcardpointrewardlist");
                while (ResultDataReader.Read())
                {
                    Godcardpointrewardlist godcardpointrewardlist = new Godcardpointrewardlist()
                    {
                        ID = (int)ResultDataReader["ID"],
                        Count = (int)ResultDataReader["Count"],
                        ...
                        Valid = (int)ResultDataReader["Valid"]
                    };
                    godcardpointrewardlistList.Add(godcardpointrewardlist);
                }
            }
            catch (Exception ex)
            {
            ...
            return godcardpointrewardlistList.ToArray();
        }
    ...
    public AchievementInfo[] GetALlAchievement()
    {
      ...
      return achievementInfoList.ToArray();
        ...
        #region Biriken Giris

        public AccumulAtiveLoginAwardInfo[] GetAccumulAtiveLoginAwardInfos()
        {
            System.Collections.Generic.List<AccumulAtiveLoginAwardInfo> list = new System.Collections.Generic.List<AccumulAtiveLoginAwardInfo>();
            SqlDataReader sqlDataReader = null;
            try
            {
                this.db.GetReader(ref sqlDataReader, "SP_AccumulAtiveLoginAward_All");
                while (sqlDataReader.Read())
                {
                    list.Add(new AccumulAtiveLoginAwardInfo
                    {
                        ID = (int)sqlDataReader["ID"],
                        RewardItemID = (int)sqlDataReader["RewardItemID"],
                        Count = (int)sqlDataReader["Count"],
                        IsSelect = (bool)sqlDataReader["IsSelect"],
                        IsBind = (bool)sqlDataReader["IsBind"],
                        RewardItemValid = (int)sqlDataReader["RewardItemValid"],
                        RewardItemCount = (int)sqlDataReader["RewardItemCount"],
            ...
            catch (System.Exception arg)
            {
                if (this.log.IsErrorEnabled)
                {
                    this.log.Error("Accumul_Ative_Login_Award：" + arg);
                }
            }
            finally
            {
    ...
    public AchievementInfo InitAchievement(SqlDataReader reader) => new AchievementInfo()
    {
      ID = (int) reader["ID"],
    ...
    public AchievementConditionInfo InitAchievementCondition(
      SqlDataReader reader) => new AchievementConditionInfo()
    {
    ...
    public AchievementRewardInfo InitAchievementReward(SqlDataReader reader) => new AchievementRewardInfo()
    {
      AchievementID = (int) reader["AchievementID"],
    ...
    public DropCondiction InitDropCondiction(SqlDataReader reader) => new DropCondiction()
    {
    ...
    public DropItem InitDropItem(SqlDataReader reader) => new DropItem()
    {
      Id = (int) reader["Id"],
      DropId = (int) reader["DropId"],
    ...
    public EdictumInfo InitEdictum(SqlDataReader reader) => new EdictumInfo()
    {
      ID = (int) reader["ID"],
      Title = reader["Title"] == null ? "" : reader["Title"].ToString(),
    ...
    public ItemRecordTypeInfo InitItemRecordType(SqlDataReader reader) => new ItemRecordTypeInfo()
    {
    ...
    public QQtipsMessagesInfo InitQQtipsMessagesLoad(SqlDataReader reader) => new QQtipsMessagesInfo()
    {
      ID = (int) reader["ID"],
    ...
    public QuestInfo InitQuest(SqlDataReader reader) => new QuestInfo()
    {
      ID = (int) reader["ID"],
    ...
    public QuestConditionInfo InitQuestCondiction(SqlDataReader reader) => new QuestConditionInfo()
    {
      QuestID = (int) reader["QuestID"],
      CondictionID = (int) reader["CondictionID"],
    ...
    public QuestAwardInfo InitQuestGoods(SqlDataReader reader) => new QuestAwardInfo()
    {
      QuestID = (int) reader["QuestID"],
    ...
    public QuestRateInfo InitQuestRate(SqlDataReader reader) => new QuestRateInfo()
    {
    ...
    public EventLiveInfo InitEventLiveInfo(SqlDataReader reader) => new EventLiveInfo()
    {
    ...
    public EventLiveGoods InitEventLiveGoods(SqlDataReader reader) => new EventLiveGoods()
    {
      EventID = (int) reader["EventID"],
      TemplateID = (int) reader["TemplateID"],
      ValidDate = (int) reader["ValidDate"],
    ...
    public CommunalActiveInfo[] GetAllCommunalActive()
    {
      ...
      return communalActiveInfoList.ToArray();
        ...
        public PetExpItemPriceInfo[] GetAllPetExpItemPriceInfoInfo()
        {
            ...
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)"GetAllPetTemplateInfo", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
      ...
      return petSkillInfoList.ToArray();
        ...
        public FightSpiritTemplateInfo[] GetAllFightSpiritTemplate()
        {
            ...
            try
            {
                ...
                while (ResultDataReader.Read())
                {
                    FightSpiritTemplateInfo spiritTemplateInfo = new FightSpiritTemplateInfo()
                    {
                    ...
                    spiritTemplateInfoList.Add(spiritTemplateInfo);
                }
            }
            catch (Exception ex)
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)"GetFightSpiritTemplateAll", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
    ...
    public ConsortiaBadgeConfigInfo InitConsortiaBadgeConfig(
      SqlDataReader reader) => new ConsortiaBadgeConfigInfo()
    {
    ...
    public GoldEquipTemplateInfo[] GetAllGoldEquipTemplateLoad()
    {
      ...
      return equipTemplateInfoList.ToArray();
        ...
        public GoldEquipTemplateInfo InitGoldEquipTemplateLoad(SqlDataReader reader) => new GoldEquipTemplateInfo()
    {
      ID = (int) reader["ID"],
       ...
       /*public GmActiveRewardInfo[] GetAllGmActiveReward()
        {
            ...
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)"InitGmActiveRewardInfo", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
        ...
        public GmActiveRewardInfo InitGmActiveRewardInfo(SqlDataReader dr) => new GmActiveRewardInfo()
        {
        ...
        public GmActiveConditionInfo[] GetAllGmActiveCondition()
        {
            ...
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)"InitGmActiveConditionInfo", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
        ...
        public GmActiveConditionInfo InitGmActiveConditionInfo(SqlDataReader dr) => new GmActiveConditionInfo()
        {
        ...
        public GmGiftInfo[] GetAllGmGift()
        {
            ...
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)"InitGmGiftInfo", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
        ...
        public GmGiftInfo InitGmGiftInfo(SqlDataReader dr) => new GmGiftInfo()
        {
            giftbagId = (string)dr["giftbagId"],
        ...
        public GmActivityInfo[] GetAllGmActivity()
        {
            ...
            {
                if (this.log.IsErrorEnabled)
                    this.log.Error((object)"InitGmActivityInfo", ex);
            }
            finally
            {
                if (ResultDataReader != null && !ResultDataReader.IsClosed)
        ...
        public GmActivityInfo InitGmActivityInfo(SqlDataReader dr) => new GmActivityInfo()
        {
            activityId = (string)dr["activityId"],
