...
namespace Bussiness
{
  public class ManageBussiness : BaseBussiness
  {
    private bool ForbidPlayer(
      ...
      int userID,
      DateTime forbidDate,
      bool isExist) => this.ForbidPlayer(userName, nickName, userID, forbidDate, isExist, "");
    ...
    public bool ForbidPlayerByNickName(string nickName, DateTime date, bool isExist) => this.ForbidPlayer("", nickName, 0, date, isExist);

    public bool ForbidPlayerByNickName(
      string nickName,
      DateTime date,
      bool isExist,
      string ForbidReason) => this.ForbidPlayer("", nickName, 0, date, isExist, ForbidReason);

    public bool ForbidPlayerByUserID(int userID, DateTime date, bool isExist) => this.ForbidPlayer("", "", userID, date, isExist);

    public bool ForbidPlayerByUserID(int userID, DateTime date, bool isExist, string ForbidReason) => this.ForbidPlayer("", "", userID, date, isExist, ForbidReason);

    public bool ForbidPlayerByUserName(string userName, DateTime date, bool isExist) => this.ForbidPlayer(userName, "", 0, date, isExist);

    public bool ForbidPlayerByUserName(
      string userName,
      DateTime date,
      bool isExist,
      string ForbidReason) => this.ForbidPlayer(userName, "", 0, date, isExist, ForbidReason);
    ...
    public int KitoffUserByNickName(string name, string msg)
    {
      using (PlayerBussiness playerBussiness = new PlayerBussiness())
      {
        ...
        return singleByNickName == null ? 2 : this.KitoffUser(singleByNickName.ID, msg);
      }
    }
    ...
    public int KitoffUserByUserName(string name, string msg)
    {
      using (PlayerBussiness playerBussiness = new PlayerBussiness())
      {
        ...
        return singleByUserName == null ? 2 : this.KitoffUser(singleByUserName.ID, msg);
      }
    }
