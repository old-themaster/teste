...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenNormalNioBoss : ABrain
	{
		...
		public ThirteenNormalNioBoss()
		{
			...
			this.int_2 = 30000;
			this.int_3 = 130000;
			this.string_0 = new string[] { "ataque ataque. Que tipo de críticas?", "Oh, tão mágico. Lustre de sangue é tão bom", "Buff para vida, ataque terno como pangolim ..", "Derrotar-nos não é fácil. Me observe." };
