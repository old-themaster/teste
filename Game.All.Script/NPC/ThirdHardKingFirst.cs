...
namespace GameServerScript.AI.NPC
{
    public class ThirdHardKingFirst : ABrain
    {
        ...
        private int lockTotemID = 3211;

        private int FagTotemID = 3210;
        ...
        private static string[] AllAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg4"),
        };

        private static string[] TwiceShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg31"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg32"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg33"),
        };

        private static string[] ThriceShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg29"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg30"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg33"),
        };

        private static string[] AddBooldChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg13"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg14"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg15"),
        };

        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg16"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg17"),
        };

        private static string[] AddEstateChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg18"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg19"),
        };

        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg6"),
        };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg26"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg27"),
        };

        private static string[] LockTotemChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg8"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg9"),
        };

        private static string[] FagTotemChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg10"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg11"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg12"),
        };

        private static string[] ShootedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg28"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg281"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg282"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg283"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg284"),
        };

        private static string[] ReliveChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg20"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg21"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg22"), 
        };

        private static string[] ReliveThankChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg23"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg24"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardKingFirst.msg25"),
        };
