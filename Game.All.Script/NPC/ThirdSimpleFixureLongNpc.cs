...
namespace GameServerScript.AI.NPC
{
    public class ThirdSimpleFixureLongNpc : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleFixureLongNpc.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleFixureLongNpc.msg2"),
        };
        #endregion
    }
}
