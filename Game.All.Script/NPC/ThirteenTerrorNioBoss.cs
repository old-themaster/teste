...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenTerrorNioBoss : ABrain
	{
		...
		public ThirteenTerrorNioBoss()
		{
			...
			this.int_2 = 30000;
			this.int_3 = 130000;
			this.string_0 = new string[] { "Ataque Ataque. Que tipo de críticas?", "Oh, tão mágico. Lustre de sangue é tão bom", "Buff para força, ataque terno como pangolim ..", "Derrotar-nos não é fácil. Me observe." };
