...
namespace GameServerScript.AI.NPC
{
    public class NormalKingLast : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg1"),
          
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg2"),
          
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg3"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg4")
        };

        private static string[] ShootChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg5"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg6"),
             
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg7"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg8"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg9")          
        };

        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg10")                          
        };

        private static string[] AngryChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg11")                          
        };

        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg12")                          
        };

        private static string[] SealChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg13")                          
        };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg14"),                  
 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg15")
        };

        private static string[] ShootedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg16"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg17"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg18")
        };

        private static string[] DiedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingLast.msg19")
        };
        #endregion
