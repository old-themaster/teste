    ...
    public class FourNormalWolfNpc : ABrain
    {
        ...
        private void FindRandomPlayer()
        {
            ...
            if(m_targetPlayer != null)
            {
                ...
                Body.Say(string.Format(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourNormalWolfNpc.msg1", m_targetPlayer.PlayerDetail.PlayerCharacter.NickName)), 0, 2000, 0);
