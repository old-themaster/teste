...
namespace GameServerScript.AI.NPC
{
    public class ThirdSimpleKingSecond : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg10"),
        };
        private static string[] KillPlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg14"),
        };
        private static string[] KillAttackChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg15"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg16"),
        };
        private static string[] SeePlayerChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg11"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg12"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg13"),
        };
        private static string[] MoveChat = new string[] { 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg8"),
        };
        ...
        public override void OnStartAttacking()
        {
            ...
            if (inattack)
            {
                ...
                Body.CallFuction(new LivingCallBack(AllAttack), 3500);
                return;
            }
            ...
            if (m_attackTurn == 3)
            {
                ...
                if (bossCount < 2)
                {
                    ...
                    SimpleBoss boss = ((PVEGame)Game).CreateBoss(3014, 1300, 600, -1, 0);
                    boss.FallFrom(1300, 702, "fall", 0, 2, 1000);
                    boss.SetRelateDemagemRect(-12, -50, 23, 37);
                    boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleKingSecond.msg1"), 0, 2000, 5000);
                    boss.AddDelay(16);
                    m_attackTurn++;
                    isSay = false;
        ...
        private void StartBeat(int beatArea)
        {
            ...
            attackObj = Game.FindNearestPlayer(Body.X, Body.Y);
        ...
        private void StartAttack()
        {
            ...
            Body.Beat(attackObj, "beatA", 800, 0, 0);
        }
        ...
        private void AllAttack()
        {
            ...
            Body.RangeAttacking(-1, Game.Map.Info.ForegroundWidth + 1, "beatB", 1800, null);
        }
        ...
        private void KillAttack()
        {
            ...
            Body.RangeAttacking(Body.X, Game.Map.Info.ForegroundWidth + 1, "beatB", 3300, null);
        }
