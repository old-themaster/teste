...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenHardNioBoss : ABrain
	{
		...
		public ThirteenHardNioBoss()
		{
			...
			this.int_2 = 30000;
			this.int_3 = 130000;
			this.string_0 = new string[] { "O café está alto. Que tipo de batida é você?", "Oh, é incrível. O lustre de sangue é tão bom", "O lustre está alto, é como um pangolim ..", "Não é fácil me derrotar. . " };
