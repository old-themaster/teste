...
namespace GameServerScript.AI.NPC
{
    public class ThirdHardLongNpcSecond : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdHardLongNpcSecond.msg8"),
        };
        #endregion
    }
}
