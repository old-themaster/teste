...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenNormalFourthBoss : ABrain
	{
		...
		public ThirteenNormalFourthBoss()
		{
			...
			this.string_1 = new string[] { "Ajudará? "," Eu os matarei um por um", "Você costumava nos comer cebolas antes. Agora não tente.", "Você será o primeiro alvo que eu mato", "Você será capaz de segurá-lo?" };
			this.string_2 = new string[] { "Você deve morrer todo o camarão", "Não sonhe em ganhar contra mim", "Ngươi nghĩ ngươi đánh bại được AD đẹp zai à?", "Ad éo cho ngươi qua đâu. Ahahaa...", "Feijão mungo matamos todos eles" };
