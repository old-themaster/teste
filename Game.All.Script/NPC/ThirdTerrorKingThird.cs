...
namespace GameServerScript.AI.NPC
{
    public class ThirdTerrorKingThird : ABrain
    {
        ...
        private int blowTotemID = 3312;

        private int bloodTotemID = 3313;

        private int isSay = 0;

        #region NPC 说话内容
        private static string[] KillPlayerChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg19"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg20"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg21"),
        };
        private static string[] ShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg5"),
        };
        private static string[] SeriesShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg3"),
        };
        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg22"),
        };
        private static string[] DieChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg18"),
        };
        private static string[] ShooteChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg23"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg231"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg232"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg233"),
        };
        private static string[] AllAttackChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg15"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg16"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg17"),
        };
        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg12"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg13"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg14"),
        };
        private static string[] BlowTotemChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg8"),
        };
        private static string[] BloodTotemChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg10"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorKingThird.msg11"),
        };
