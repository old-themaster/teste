...
namespace GameServerScript.AI.NPC
{
    public class HardCaptainAi : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg1"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg2"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg3")
        };

        private static string[] ShootChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg4"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg5")
        };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg6"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg7")
        };

        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg8"),
                  
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg9")
        };

        private static string[] JumpChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg10"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg11"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg12")
        };

        private static string[] KillAttackChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg13")
        };

        private static string[] KillChat = new string[]{
           LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg14"),

           LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg15")
        };

        private static string[] ShootedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg16"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg17")
        };

        private static string[] DiedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardCaptainAi.msg18")
        };
