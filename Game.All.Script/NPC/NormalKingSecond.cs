...
namespace GameServerScript.AI.NPC
{
    public class NormalKingSecond : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] { 
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg1"),
       
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg2"),
       
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg3")
        };

        private static string[] ShootChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg4"),
                               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg5"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg6")
        };

        private static string[] AddBooldChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg7"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg8"),
                
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg9")
         
        };

        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg10")
        };

        private static string[] FrostChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg11"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg12"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg13")
              
        };

        private static string[] WallChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg14"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg15")
         };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg16"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg17"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg18")
        };

        private static string[] ShootedChat = new string[]{
          LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg19"),
                   
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg20")
        };

        private static string[] DiedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.NormalKingSecond.msg21")    
        };
        #endregion
        ...
        public override void OnDiedSay()
        {
            ...
            Body.Say(DiedChat[index], 1, 1500, 2500);
        }
