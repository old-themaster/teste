...
{
    public class TNSM3106 : AMissionControl
    {
        ...
        private int bloomID = 3113;

        private int npcID = 3103;

        private int blownpcID = 3112;

        private int bloomSnpcID = 3118;
        ...
        public override void OnPrepareNewGame()
        {
            ...
            firstBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TNSM3106.msg1"), 0, 3000);
