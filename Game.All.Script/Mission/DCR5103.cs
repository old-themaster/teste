...
namespace GameServerScript.AI.Messions
{
    public class DCR5103 : AMissionControl
    {
        ...
        public override void OnStartGame()
        {
            ...
            m_boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg1"), 0, 1000);
        ...
        private void CreateEffectEndGame()
        {
            ...
            m_tempBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalBossThird.msg19"), 0, 1000);
        ...
        private void CreateNpcEndGame()
        {
            ...
            npc.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveNormalElderThird.msg1"), 0, 4000, 2000);
