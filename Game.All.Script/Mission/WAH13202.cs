...
namespace Game.Server.GameServerScript.AI.Messions
{
    public class WAH13202 : AMissionControl
	{
		...
		private void method_0()
		{
			...
			this.simpleNpc_0 = base.Game.CreateNpc(this.int_1, 701, 594, 1, 1, "", livingConfig);
		...
		private void method_1()
		{
			...
			livingConfig.CanTakeDamage = false;
			livingConfig.IsFly = true;
			this.simpleBoss_1 = base.Game.CreateBoss(this.int_2, 1604, 594, -1, 1, "", livingConfig);
		...
		private void method_2()
		{
			...
			this.simpleNpc_0.Say("Esse poderia ser o preço a pagar por um ritual maligno?", 0, 4000);
			...
			this.simpleBoss_1.Say("Espere por isso. Eu ainda vou voltar ..", 1, 9000);
		...
		{
			base.Game.RemoveLiving(this.simpleNpc_0.Id);
		}

		private void method_4()
		{
			base.Game.RemoveLiving(this.simpleBoss_1.Id);
		}
