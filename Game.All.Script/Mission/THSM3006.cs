...
{
    public class THSM3006 : AMissionControl
    {
        ...
        private int m_state = 3016;

        private int firstbossID = 3016;

        private int secondbossID = 3017;

        private int bloomID = 3013;

        private int npcID = 3003;

        private int blownpcID = 3012;

        private int bloomSnpcID = 3018;
