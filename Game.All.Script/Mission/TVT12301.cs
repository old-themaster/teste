...
{
    public class TVT12301 : AMissionControl
	{
		private List<SimpleNpc> npcList = new List<SimpleNpc>();

		private int BossID = 12303;

		private int BigVolverineNPC = 12302;

		private int VolverineNPC = 12301;

		private int ChickenHelp = 12304;
		...
		private void CreateVolverineBoss()
		{
            ...
            //VolverineBOSS.FallFrom(VolverineBOSS.X, VolverineBOSS.Y, "", 2000, 0, 0, null);
           // VolverineBOSS.SetThumbnailBoss(false);
