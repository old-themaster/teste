...
namespace GameServerScript.AI.Messions
{
    public class DCR5302 : AMissionControl
    {
        ...
        private int bossId = 5314;

        private int npcId = 5311;

        private int npcLeftId = 5312;

        private int npcRightId = 5313;

        private int npcBottomId = 5316;

        private int npcCenterId = 5317;

        private int npcHelperId = 5304;
        ...
        private void CreateBossAndNpc()
        {
            ...
            m_boss = Game.CreateBoss(bossId, 1478, 596, -1, 1, 0, "born", Game.BaseLivingConfig());
            ...
            // left npc
            m_npcLeft = Game.CreateBoss(npcLeftId, 1323, 663, -1, 0, 0, "", Game.BaseLivingConfig());
            ...
            m_npcRight = Game.CreateBoss(npcRightId, 1664, 532, -1, 0, 0, "", Game.BaseLivingConfig());
        ...
        {
            //1022, 828
            m_helper = Game.CreateNpc(npcHelperId, 1022, 828, 0, 1, "standB", null);
            Game.SendObjectFocus(m_helper, 1, 1000, 0);
            m_helper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveTerrorElderSecond.msg1"), 0, 2000);
