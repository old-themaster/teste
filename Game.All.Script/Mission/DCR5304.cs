...
namespace GameServerScript.AI.Messions
{
    public class DCR5304 : AMissionControl
    {
        ...
        private int npcHelperId1 = 5333;

        private int npcHelperId2 = 5334;
        ...
        public override void OnStartGame()
        {
            ...
            m_boss = Game.CreateBoss(bossId, 1700, 480, -1, 1, 100, "", config);
        ...
        private void CreateHelperNpc()
        {
            ...
            m_npcHelper.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FiveTerrorElderFour.msg1"), 0, 3000, 2000);
        }
