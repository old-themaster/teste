...
// Type: Tank.Request.ConsortiaApplyUsersList
  ...
  public class ConsortiaApplyUsersList : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      try
      {
        ...
        {
          foreach (ConsortiaApplyUserInfo info in consortiaBussiness.GetConsortiaApplyUserPage(page, size, ref total, order, consortiaID, applyID, userID))
            node.Add((object) FlashUtils.CreateConsortiaApplyUserInfo(info));
          flag = true;
          str = "Success!";
        }
      }
      ...
      {
        ConsortiaApplyUsersList.log.Error((object) nameof (ConsortiaApplyUsersList), ex);
      }
