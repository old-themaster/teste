...
// Type: Tank.Request.ConsortiaAllyList
...
namespace Tank.Request
{
  ...
  public class ConsortiaAllyList : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      try
      {
        ...
        using (ConsortiaBussiness consortiaBussiness = new ConsortiaBussiness())
        {
          foreach (ConsortiaAllyInfo info in consortiaBussiness.GetConsortiaAllyPage(page, size, ref total, order, consortiaID, state, name))
            node.Add((object) FlashUtils.CreateConsortiaAllyInfo(info));
          flag = true;
          str = "Success!";
        }
      }
      ...
      {
        ConsortiaAllyList.log.Error((object) nameof (ConsortiaAllyList), ex);
      }
