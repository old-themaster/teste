...
// Type: Tank.Request.LoadUserItems
  ...
  public class LoadUserItems : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      try
      {
        ...
        {
          foreach (SqlDataProvider.Data.ItemInfo info in playerBussiness.GetUserItem(UserID))
      ...
      {
        LoadUserItems.log.Error((object) nameof (LoadUserItems), ex);
      }
