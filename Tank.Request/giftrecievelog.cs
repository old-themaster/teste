...
// Type: Tank.Request.giftrecievelog
  ...
  public class giftrecievelog : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      try
      {
        ...
        {
          UserGiftInfo[] allUserGifts = playerBussiness.GetAllUserGifts(userid, true);
      ...
      {
        giftrecievelog.log.Error((object) nameof (giftrecievelog), ex);
      }
