        ...
        private readonly List<int> AllowedItems = new List<int>()
    {
      ...
      10021
          ...
          : base(id, game, team, "", "", maxBlood, 0, 1)
        {
            ...
            this.m_player.UpdateGamePlayerId();
                        ...
                        if (key != null)
                        {
                            switch (key)
                            {
                                ...
                                case "1457"://
                                    ...
                                    continue;
                                case "1046"://
                                    new CASE1046(coldDown, probability, gameType, num, delay, elementID).Start((Living)this);
                                    continue;
                                #endregion
                                #region PET Green
                                case "1358"://
                                ...
                                case "1376"://
                                    ...
                                    continue;
                                case "1026"://
                                    new CASE1026(coldDown, probability, gameType, num, delay, elementID).Start((Living)this);
                                    continue;
                                case "1027"://
                                    new CASE1027(coldDown, probability, gameType, num, delay, elementID).Start((Living)this);
                                    continue;
                                case "1028"://
                                    new CASE1028(coldDown, probability, gameType, num, delay, elementID).Start((Living)this);
                                    continue;
                                ...
                                case "1025"://
                                    ...
                                    continue;
                                case "1054"://
                                    new CASE1054(coldDown, probability, gameType, num, delay, elementID).Start((Living)this);
                                    continue;
                                case "1055"://
                                    new CASE1055(coldDown, probability, gameType, num, delay, elementID).Start((Living)this);
                                    continue;
                                case "1056"://
        ...
        {
            if (this.m_game.RoomType == eRoomType.Dungeon && m_game.RoomType != eRoomType.SpecialActivityDungeon)
            ...
            this.BaseDamage += (double)(this.m_player.PlayerCharacter.DameAddPlus + base.FightBuffers.WorldBossAttrack_MoneyBuff);
            ...
            if (this.FightBuffers.ConsortionAddMaxBlood > 0)
                this.m_maxBlood += this.m_maxBlood * this.FightBuffers.ConsortionAddMaxBlood / 100;
            this.m_maxBlood += this.m_player.PlayerCharacter.HpAddPlus + base.FightBuffers.WorldBossHP + base.FightBuffers.WorldBossHP_MoneyBuff + base.PetEffects.MaxBlood;
            ...
            if (this.m_game.RoomType == eRoomType.Freedom || this.m_game.GameType == eGameType.Guild)
            {
                if (this.m_game.RoomType == eRoomType.Freedom)
                {
                        base.Reset();
                        return;
                }
                if (this.m_game.GameType == eGameType.Guild)
                {
                ...
                //var balanceAttribute = GameProperties.BalanceModeAttribute.Split(',');
                //for (int i = 0; i < balanceAttribute.Length; i++)
                //{
                    Attack = Convert.ToInt32(1500);
                    Defence = Convert.ToInt32(1500);
                    Agility = Convert.ToInt32(1500);
                    Lucky = Convert.ToInt32(1500);
                    Blood = Convert.ToInt32(18000);
                    MaxBlood = Convert.ToInt32(18000);
                    m_maxBlood = Convert.ToInt32(18000);
                    BaseDamage = Convert.ToInt32(1100);
                    BaseGuard = Convert.ToInt32(500);
                    m_energy = Convert.ToInt32(300);
                    base.PetMP = Convert.ToInt32(0);
               // }
               // base.PetEffects.DisibleActiveSkill = true;
            }
            base.Reset();
        }
        ...
        public bool Shoot(int x, int y, int force, int angle)
        {
            ...
            if (this.m_shootCount > 0)
            {
                ...
                if (this.ShootImp(bombId, x, y, force, angle, this.m_ballCount))
                {
                    if (bombId == 4)
                    ...
                    if (this.m_shootCount <= 0 || !this.IsLiving)
                    {
                        ...
                        if (this.CanGetProp)
                        {
                            ...
                            if (DropInventory.FireDrop(this.m_game.RoomType, ref info) && info != null)
                            {
                                ...
                                {
                                    ShopMgr.FindSpecialItemInfo(itemInfo, ref gold, ref money, ref giftToken, ref medal, ref Ascension, ref honor, ref hardCurrency, ref token, ref dragonToken, ref magicStonePoint);
        ...
        public void PetUseKill(int skillID, int type)
        {
            ...
            if (this.PetMP > 0 && this.PetMP >= petSkill.CostMP)
            {
                ...
                this.m_player.SendMessage("energia não é suficiente.");
        }
