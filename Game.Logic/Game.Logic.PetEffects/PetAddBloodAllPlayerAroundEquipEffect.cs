...
// Type: Game.Logic.PetEffects.PetAddBloodAllPlayerAroundEquipEffect
...
namespace Game.Logic.PetEffects
{
  public class PetAddBloodAllPlayerAroundEquipEffect : BasePetEffect
  {
    ...
    public PetAddBloodAllPlayerAroundEquipEffect(
      int count,
      int probability,
      int type,
      int skillId,
      int delay,
      string elementID)
      : base(ePetEffectType.PetAddBloodAllPlayerAroundEquipEffect, elementID)
    {
      this.m_count = count;
    ...
    private void player_AfterKilledByLiving(Living living)
    {
      ...
      new PetAddBloodAllPlayerAroundEquip(this.m_count, this.m_currentId, this.Info.ID.ToString()).Start(living);
    }
