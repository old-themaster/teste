...
{
    public class CASE1460 : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1460(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1460, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1460 pE = living.PetEffectList.GetOfType(ePetEffectType.CASE1460) as CASE1460;
            if (pE != null)
            {
        ...
        private void method_0(Living living_0, Living living_1, int int_7, int int_8)
        {
            if (living_0.PetEffects.ActiveEffect)
            {
                ...
                if (this.int_6 > 0)
                {
                    ...
                    {
                        living_1.AddPetEffect(new CASE1460A(0, this.int_2, this.int_0, this.int_5, this.int_3, base.Info.ID.ToString()), 0);
                    }
                    living_0.PetEffects.ActiveEffect = false;
                    Console.WriteLine("refletir 5% de HP");
                }
            }
        }
