...
// Type: Game.Logic.PetEffects.PetAddDefendEquipEffect
...
namespace Game.Logic.PetEffects
{
  public class PetAddDefendEquipEffect : BasePetEffect
  {
    ...
    public PetAddDefendEquipEffect(
      int count,
      int probability,
      int type,
      int skillId,
      int delay,
      string elementID)
      : base(ePetEffectType.PetDefendEquipEffect, elementID)
    {
      this.m_count = count;
    ...
    {
      PetAddDefendEquipEffect ofType = living.PetEffectList.GetOfType(ePetEffectType.PetDefendEquipEffect) as PetAddDefendEquipEffect;
      if (ofType == null)
