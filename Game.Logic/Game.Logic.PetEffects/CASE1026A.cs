...
{
    public class CASE1026A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1026A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1026A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1026A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1026A) as CASE1026A;
            if (cE != null)
            {
