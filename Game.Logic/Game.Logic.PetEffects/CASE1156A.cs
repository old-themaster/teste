...
{
    public class CASE1156A : BasePetEffect
    {
        private int int_0;
        private int int_1;
        private int int_2;
        ...
        private int int_5;
        private int int_6;
        public CASE1156A(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.CASE1156A, elementID)
        {
            this.int_1 = count;
            this.int_4 = count;
        ...
        {
            CASE1156A cE = living.PetEffectList.GetOfType(ePetEffectType.CASE1156A) as CASE1156A;
            if (cE != null)
            {
