...
namespace Bussiness
{
    public abstract class GameProperties
    {
        ...
        [ConfigProperty("servidor", "", "default")]
        ...
        [ConfigProperty("SanXiaoEndTime", "SanXiaoEndTime", "2050/2/16 0:00:00")]
        ...
        public readonly static string LuckStarActivityBeginDate;
        [ConfigProperty("LuckStarActivityEndDate", "LuckStarActivityEndDate", "2050/12/24 0:00:00")]
        public readonly static string LuckStarActivityEndDate;
        ...
        [ConfigProperty("YearMonsterHP", "YearMonsterHP", 2000000)]
        ...
        [ConfigProperty("SendLittleGameActived", "SendLittleGameActived", "2012-01-01 20:55:27.270")]
        public static string SendLittleGameActived;
        public static DateTime SummerAcitveEndTime;
        ...
        public static readonly string MysteryShopOpenTime; //MysteryShopOpenTime	12|0
        [ConfigProperty("MysteryShopFreshTime", "MysteryShopFreshTime", 18)]
        public static readonly int MysteryShopFreshTime; //MysteryShopFreshTime	18
        ...
        public readonly static string HalloweenEndDate;
        [ConfigProperty("DDPlayBeginDate", "DDPlayBeginDate", "2015/01/03 0:00:00")]
        public readonly static string DDPlayBeginDate;
        [ConfigProperty("DDPlayEndDate", "DDPlayEndDate", "2015/03/03 0:00:00")]
        public readonly static string DDPlayEndDate;
        [ConfigProperty("DDPlayMoney", "DDPlayMoney", 100)]
        public readonly static int int_0;
        [ConfigProperty("ExchangeFold", "ExchangeFold", 1000)]
        public readonly static int ExchangeFold;
        [ConfigProperty("GunLevelLimit", "GunLevelLimit", 12)]
        public readonly static int GunLevelLimit;

        [ConfigProperty("ClothLevelLimit", "ClothLevelLimit", 12)]
        public readonly static int ClothLevelLimit;

        [ConfigProperty("HatLevelLimit", "HatLevelLimit", 12)]
        public readonly static int HatLevelLimit;

        [ConfigProperty("ItemSecond", "ItemSecondLmit", 12)]
        public readonly static int ItemSecondLimit;


        [ConfigProperty("BalanceModeAttribute", "BalanceModeAttribute", "1500,1500,1500,1500,18000,18000,18000,1200,500,300,0")]
        public static readonly string BalanceModeAttribute;

        [ConfigProperty("MoneyBattleWin", "MoneyBattleWin", 200)]
        public readonly static int MoneyBattleWin;

        [ConfigProperty("MoneyBattleLose", "MoneyBattleLose", 100)]
        public readonly static int MoneyBattleLose;


        public static int ConsortiaStrengExp(int Lv) => GameProperties.getProp(GameProperties.ConsortiaStrengthenEx)[Lv];
        ...
        public static int HoleLevelUpExp(int lv) => GameProperties.getProp(GameProperties.HoleLevelUpExpList)[lv];
        ...
        "9999999"
            ...
            switch (str)
            {
                ...
                case "PyramidRevivePrice":
                    ...
                    break;
                case "BoguAdventurePrice":
                    strArray = GameProperties.BoguAdventurePrice.Split(',');
                    break;
            }
        ...
        public static int LimitLevel(int index) => Convert.ToInt32(GameProperties.CustomLimit.Split('|')[index]);
        ...
        public static Dictionary<int, int> AcademyApprenticeAwardArr() => GameProperties.ConvertIntDict(GameProperties.AcademyApprenticeAward, ',', '|');

        public static Dictionary<int, int> AcademyMasterAwardArr() => GameProperties.ConvertIntDict(GameProperties.AcademyMasterAward, ',', '|');

        public static int[] AcademyMasterExpPlusArr() => GameProperties.ConvertIntArray(GameProperties.AcademyMasterExpPlus, '|');
        ...
        public static int VIPStrengthenExp(int vipLv) => GameProperties.getProp(GameProperties.VIPStrengthenEx)[vipLv];

        public static int[] MissionRichesArr() => GameProperties.ConvertIntArray(GameProperties.MissionRiches, '|');

        public static int[] MissionAwardRichesArr() => GameProperties.ConvertIntArray(GameProperties.MissionAwardRiches, '|');

        public static int[] MissionAwardGPArr() => GameProperties.ConvertIntArray(GameProperties.MissionAwardGP, '|');

        public static int[] MissionAwardOfferArr() => GameProperties.ConvertIntArray(GameProperties.MissionAwardOffer, '|');
    }
}
