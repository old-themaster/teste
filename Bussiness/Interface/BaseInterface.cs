...
namespace Bussiness.Interface
{
  public abstract class BaseInterface
  {
    ...
    public static string LoginUrl => ConfigurationManager.AppSettings[nameof (LoginUrl)];
    ...
    public static DateTime ConvertIntDateTime(double d) => TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1)).AddSeconds(d);
    ...
    public static string md5(string str) => FormsAuthentication.HashPasswordForStoringInConfigFile(str, nameof (md5)).ToLower();

    public static string RequestContent(string Url) => BaseInterface.RequestContent(Url, 2560);
    ...
    public static BaseInterface CreateInterface()
    {
      ...
      return !(getInterName == "duowan") ? (BaseInterface) null : (BaseInterface) new DWInterface();
    }
    ...
    public virtual bool GetUserSex(string name) => true;

    public static bool CheckRnd(string str) => !string.IsNullOrEmpty(str);
  }
}
