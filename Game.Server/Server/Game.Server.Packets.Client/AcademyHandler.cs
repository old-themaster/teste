...
// Type: Game.Server.Packets.Client.AcademyHandler
...
namespace Game.Server.Packets.Client
{
  ...
  public class AcademyHandler : IPacketHandler
  {
    ...
    private int checkDate(DateTime dateTime) => dateTime > DateTime.Now ? (int) Math.Ceiling((dateTime - DateTime.Now).TotalHours) : 0;
  }
}
