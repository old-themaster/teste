              ...
              else
              {
                  ...
                  else
                  {
                    ...
                    if (client.Player.Level == LevelMgr.MaxLevel)
                    {
                      ...
                      if (num4 > 0)
                      {
                        ...
                        translateId2 = string.Format("", (object) num4);
                      }
                    }
                    else
                    {
                ...
                else if (itemInfo2.TemplateID == 11992)
                {
                  ...
                  using (PlayerBussiness playerBussiness = new PlayerBussiness())
                  {
                    ...
                    playerBussiness.VIPRenewal(client.Player.PlayerCharacter.NickName, itemInfo2.ValidDate, typeVIP, ref now);
                    if (itemInfo2.ValidDate == 0)
                      itemInfo2.ValidDate = 1;
                    if (client.Player.PlayerCharacter.typeVIP == (byte) 0)
                    {
                      client.Player.OpenVIP(itemInfo2.ValidDate, now);
