...
namespace Game.Server.Packets.Client
{
  ...
  internal class MarryApplyReplyHandler : IPacketHandler
  {
    ...
    {
      string translation = LanguageMgr.GetTranslation("MarryApplyReplyHandler.Msg1", (object) (player.PlayerCharacter.Sex ? player.PlayerCharacter.NickName : spouse.NickName), (object) (player.PlayerCharacter.Sex ? spouse.NickName : player.PlayerCharacter.NickName));
