...
// Type: Game.Server.Packets.Client.DailyAwardHandler
    ...
    public int HandlePacket(GameClient client, GSPacketIn packet)
    {
      ...
      switch (type)
      {
        ...
        case 2:
          ...
          if (!ItemBoxMgr.CreateItemBox(ItemMgr.FindItemTemplate(112059).TemplateID, itemInfos, ref gold, ref point, ref giftToken, ref medal, ref Ascension, ref exp))
          {
        ...
        case 3:
          if (client.Player.PlayerCharacter.CanTakeVipReward)
          {
            ...
            if (!ItemBoxMgr.CreateItemBox(ItemMgr.FindItemTemplate(ItemMgr.FindItemBoxTypeAndLv(2, vipLevel).TemplateID).TemplateID, itemInfos, ref gold, ref point, ref giftToken, ref medal, ref Ascension, ref exp))
            {
              client.Player.SendMessage(LanguageMgr.GetTranslation("Error.ChangeChannel"));
              return 0;
            }
          ...
          {
            stringBuilder1.Append("Você recebeu sua recompensa hoje!");
            break;
          }
        case 5:
          using (PlayerBussiness playerBussiness = new PlayerBussiness())
      ...
      if (medal != 0)
      {
        stringBuilder1.Append(Ascension.ToString() + LanguageMgr.GetTranslation("OpenUpArkHandler.Ascension"));
        client.Player.AddAscension(Ascension);
      }
