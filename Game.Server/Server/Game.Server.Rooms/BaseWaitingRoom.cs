...
namespace Game.Server.Rooms
{
    public class BaseWaitingRoom
  {
    ...
    public BaseWaitingRoom() => this.dictionary_0 = new Dictionary<int, GamePlayer>();
    ...
    {
      GamePlayer[] gamePlayerArray = (GamePlayer[]) null;
      List<GamePlayer> list4 = new List<GamePlayer>();
      List<BaseRoom> list7 = new List<BaseRoom>();
    ...
    public void method_0(GSPacketIn packet) => this.method_1(packet, (GamePlayer) null);
