...
// Type: Game.Server.Achievement.ChangeFightPowerCondition
...
namespace Game.Server.Achievement
{
    public class ChangeFightPowerCondition : BaseUserRecord
  {
    ...
    private void player_PlayerPropertyChanged(PlayerInfo character) => this.m_player.AchievementInventory.UpdateUserAchievement(this.m_type, character.FightPower, 1);
