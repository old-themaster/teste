...
namespace Game.Server.Battle
{
    public class FightServerConnector : BaseConnector
    {
            ...
            try
            {
                ...
                switch (gsPacketIn.Code)
                {
                    ...
                    case 88:
                        ...
                        break;
                    case 90:
                        this.HandlePlayerAddEnterModePoint(gsPacketIn);
                        return;

                    case 0x5b:
                        this.HandleCreateEnterModeItems(gsPacketIn);
                        return;
                    case 200:
        ...
        private void HandleCreateEnterModeItems(GSPacketIn pkg)
        {
            GamePlayer playerById = WorldMgr.GetPlayerById(pkg.ClientID);
            if (playerById != null)
            {
                playerById.CreateRandomEnterModeItem();
            }
        }
        ...
        private void HandleFightNPC(GSPacketIn gspacketIn_0)
        {
            ...
            int playerCount = gspacketIn_0.ReadInt();
            ...
            {
                RingStationMgr.CreateAutoBot(playerById, roomtype, gametype, npcId, playerCount);
        ...
        private void HandlePlayerAddEnterModePoint(GSPacketIn pkg)
        {
            GamePlayer playerById = WorldMgr.GetPlayerById(pkg.ClientID);
            if (playerById != null)
            {
                playerById.AddEnterModePoint(pkg.Parameter1);
            }
        }
