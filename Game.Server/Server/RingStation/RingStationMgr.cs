...
// Type: Game.Server.RingStation.RingStationMgr
	...
	public sealed class RingStationMgr
	{
	  ...
	  "7027|ghostaxe"
		...
		public static int GetAutoBot(GamePlayer player, int roomtype, int gametype)
		{
			...
			player1.Colors = ",,,,,,,,,,,,,,,";
			player1.typeVIP = player.PlayerCharacter.typeVIP;
			player1.VIPLevel = player.PlayerCharacter.VIPLevel;
			player1.Nimbus = player.PlayerCharacter.Nimbus;
		...
		public static void CreateAutoBot(GamePlayer player, int roomtype, int gametype, int npcId, int playerCount = 1)
		{
			BaseRoomRingStation room = new BaseRoomRingStation(RingStationConfiguration.NextRoomId())
			{
				RoomType = roomtype,
			...
			for(int i = 0; i < playerCount; i++)
			{
				...
				player1.ID = (npcId + i);
				if(gametype == (int)eGameType.Guild)
				{
					player1.ConsortiaID = 2000;
					player1.ConsortiaName = "NovaEra";
				}
		...
		public static UserRingStationInfo GetSingleRingStationInfos(int playerId) => RingStationMgr.dictionary_1.ContainsKey(playerId) ? RingStationMgr.dictionary_1[playerId] : (UserRingStationInfo)null;
		...
		private static DateTime smethod_0(
		  RingstationBattleFieldInfo ringstationBattleFieldInfo_0) => ringstationBattleFieldInfo_0.BattleTime;

		private static bool smethod_1(UserRingStationInfo userRingStationInfo_0) => (uint)userRingStationInfo_0.Rank > 0U;

		private static int smethod_2(UserRingStationInfo userRingStationInfo_0) => userRingStationInfo_0.Rank;

		private static int smethod_3(UserRingStationInfo userRingStationInfo_0) => userRingStationInfo_0.Total;

		private static bool smethod_4(UserRingStationInfo userRingStationInfo_0) => (uint)userRingStationInfo_0.Rank > 0U;

		private static int smethod_5(UserRingStationInfo userRingStationInfo_0) => userRingStationInfo_0.Rank;
							...
							if (itemTemplate != null)
							{
								foreach (UserRingStationInfo userRingStationInfo in userRingStationInfoList)
								{
									...
									if (num > 0)
									{
										...
										if (WorldEventMgr.SendItemsToMail(infos, userRingStationInfo.UserID, userRingStationInfo.Info.NickName, translation))
		...
		public static string GetAutoBotStyleRandom(string weapon)
		{
			...
			switch (new Random().Next(1, 20))
			{
				...
				case 5:
					...
					break;
				case 6:
					str = string.Format("1137|head42,2106|glass5,3150|hair50,,5130|cloth30,,{0},13503|suits303,,", (object)weapon);
					break;
				case 7:
					str = string.Format(",,3170|hair70,4104|eff4,5303|cloth103,6134|face33,{0},,,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 8:
					str = string.Format(",,3308|hair108,4104|eff4,5145|cloth45,6131|face30,{0},13503|suits303,15048|wing48,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 9:
					str = string.Format(",,3164|hair64,4104|eff4,5112|cloth11,6128|face27,{0},13497|suits297,15048|wing48,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 10:
					str = string.Format(",,3160|hair60,4104|eff4,5140|cloth40,6135|face34,{0},13497|suits297,15026|wing026,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 11:
					str = string.Format(",,,,,,{0},13145|suits45,,,,,,,,", (object)weapon);
					break;
				case 12:
					str = string.Format(",,3163|hair63,4104|eff4,5107|cloth6,6120|face19,{0},13467|suits267,15004|wing004,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 13:
					str = string.Format(",,3150|hair50,4148|eff48,5136|cloth36,6115|face14,{0},13449|suits249,15026|wing026,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 14:
					str = string.Format(",,3138|hair38,4104|eff4,5107|cloth6,6120|face19,{0},13145|suits45,15026|wing026,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 15:
					str = string.Format(",,3143|hair43,4117|eff17,5137|cloth37,6105|face4,{0},13449|suits249,15026|wing026,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 16:
					str = string.Format(",,3125|hair25,4118|eff18,5128|cloth28,6116|face15,{0},13145|suits45,15026|wing026,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 17:
					str = string.Format(",,3110|hair9,4117|eff17,5137|cloth37,6120|face19,{0},13311|suits111,15026|wing026,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 18:
					str = string.Format(",,3135|hair35,4117|eff17,5131|cloth31,6105|face4,{0},13449|suits249,15004|wing004,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 19:
					str = string.Format(",,3151|hair51,4117|eff17,5141|cloth41,6110|face9,{0},13311|suits111,15003|wing003,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
				case 20:
					str = string.Format(",,3107|hair6,4117|eff17,5135|cloth35,6120|face19,{0},13351|suits151,15003|wing003,,17002|offhand2,9522|ring55,,,,", (object)weapon);
					break;
			}
			return str;
		}

		public static RingstationConfigInfo ConfigInfo => RingStationMgr._ringstationConfigInfo;

		public static VirtualPlayerInfo NormalPlayer
		{
			get => RingStationMgr._virtualPlayerInfo;
			set => RingStationMgr._virtualPlayerInfo = value;
		}
	}
}
