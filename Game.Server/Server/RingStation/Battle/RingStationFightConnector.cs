...
namespace Game.Server.RingStation.Battle
{
    public class RingStationFightConnector : BaseConnector
  {
    ...
    protected void HandleRoomRemove(GSPacketIn packet) => this.m_server.RemoveRoomImp(packet.ClientID);
    ...
    protected void HandleSendToRoom(GSPacketIn pkg) => this.m_server.SendToRoom(pkg.ClientID, pkg.ReadPacket(), pkg.Parameter1, pkg.Parameter2);
    ...
    protected void HandleStopGame(GSPacketIn pkg) => this.m_server.StopGame(pkg.Parameter1, pkg.Parameter2);

    private void HandleUpdatePlayerGameId(GSPacketIn pkg) => this.m_server.UpdatePlayerGameId(pkg.Parameter1, pkg.Parameter2);
    ...
    public void SendAddRoom(BaseRoomRingStation room)
    {
      ...
      foreach (RingStationGamePlayer stationGamePlayer in players)
      {
        ...
        pkg.WriteInt(stationGamePlayer.Nimbus);
    ...
    public void SendRemoveRoom(BaseRoomRingStation room) => this.SendTCP(new GSPacketIn((short) 65)
    {
