...
namespace Game.Server.GameUtils
{
    public class PlayerProperty
  {
    ...
    public void ViewOther(PlayerInfo player) => this.m_player.Out.SendUpdatePlayerProperty(player, this);

    public Dictionary<string, Dictionary<string, int>> Current
    {
      get => this.m_playerProperty;
      set => this.m_playerProperty = value;
    }

    public int Loading
    {
      get => this.m_loading;
      set => this.m_loading = value;
    }
    ...
    {
      get => this.m_totalArmor;
      set => this.m_totalArmor = value;
    }

    public int totalDamage
    {
      get => this.m_totalDamage;
      set => this.m_totalDamage = value;
    }
  }
}
