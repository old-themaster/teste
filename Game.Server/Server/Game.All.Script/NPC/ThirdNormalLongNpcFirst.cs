...
namespace GameServerScript.AI.NPC
{
    public class ThirdNormalLongNpcFirst : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdNormalLongNpcFirst.msg8"),
        };
        #endregion
    }
}
