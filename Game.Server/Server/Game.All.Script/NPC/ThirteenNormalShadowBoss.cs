...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenNormalShadowBoss : ABrain
	{
		...
		public ThirteenNormalShadowBoss()
		{
			...
			this.string_1 = new string[] { "Será que vai apoiá-lo?", "Eu vou matá-los um por um", "Você costumava nos comer cebolas antes. Agora não tente.", "Você será o primeiro alvo que eu mato", "Você será capaz de lidar com isso? " };
			this.string_2 = new string[] { "Você deve morrer todo o camarão", "Não sonhe em ganhar contra mim", "Você acha que pode vencer o AD zai bonito?", "Ad éo cho ngươi qua đâu. Ahahaa...", "Feijão mungo matamos todos eles" };
			this.string_3 = new string[] { "Não aguento mais", "Mọe chứ chơi lại chiêu cũ. Chết chùm luôn", "Se eu morrer, você deve morrer.", "Não suporto se a bandeira estiver sinalizada", "Chega de brincadeira. Todos mortos. Mate todos eles" };
