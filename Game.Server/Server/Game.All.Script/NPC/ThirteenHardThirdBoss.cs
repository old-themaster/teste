...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenHardThirdBoss : ABrain
	{
		...
		public ThirteenHardThirdBoss()
		{
			...
			this.string_2 = new string[] { "O que há de errado com você?", "Seu idiota brain aprende nada.", "Você quer que eu seja esfolada?", "Esse cocô está me apertando?", "Você está ajudando ou me ajudando?" };
