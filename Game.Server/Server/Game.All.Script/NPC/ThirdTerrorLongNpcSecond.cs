...
namespace GameServerScript.AI.NPC
{
    public class ThirdTerrorLongNpcSecond : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdTerrorLongNpcSecond.msg8"),
        };
        #endregion
    }
}
