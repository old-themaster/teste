...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenHardAntBoss : ABrain
	{
		...
		public ThirteenHardAntBoss()
		{
			...
			this.int_1 = 13202;
			this.xoYsxiyXcgd = new string[] { "Tente aguenta esta minha flecha", "Veja se não está disponível", "Eu vou matar todos vocês", "Você acha que é o suficiente para me abaixar?" };
			this.string_0 = new string[] { "O broche de fita se soltou.", "Lamber meu broche de fita", "Deixe-me ajudá-lo a voltar ao céu rapidamente." };
