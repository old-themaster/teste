...
namespace GameServerScript.AI.NPC
{
    public class ThirdSimpleShortNpcSecond : ABrain
    {
        ...
        private static string[] AntChat = new string[] {
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg1"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg2"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg3"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg6"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg8"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg9"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.ThirdSimpleShortNpcSecond.msg10")
        };
        #endregion
    }
}
