...
namespace GameServerScript.AI.NPC
{
    public class FourHardWolfNpc : ABrain
    {
        ...
        private int friendlyNpcId = 4205;
        ...
        private void FindRandomPlayer()
        {
            ...
            if (m_targetPlayer != null)
            {
                ...
                Body.Say(string.Format(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.FourHardWolfNpc.msg1", m_targetPlayer.PlayerDetail.PlayerCharacter.NickName)), 0, 2000, 0);
