...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenNormalDevilBoss : ABrain
	{
		...
		private void method_0()
		{
			...
			base.Body.MoveTo(900, 400, "fly", 1000, 10, new LivingCallBack(this.method_1));
		}
		...
		private void method_10()
		{
			...
			base.Body.Say("Deixe-me cortar vocês aqui.", 0, 1000);
			base.Body.MoveTo(this.m_targer.X, this.m_targer.Y, "fly", 1500, 10, new LivingCallBack(this.method_11));
		}
		...
		private void method_12()
		{
			...
			base.Body.MoveTo(num, num1, "fly", 1000, 10, new LivingCallBack(this.method_14));
		}
		...
		private void method_17()
		{
			...
			base.Body.Say("Por que esse valor é grande e pesado?", 0, 1000);
		...
		{
			base.Body.Say(string.Concat(base.Game.ListPlayersName(), ", Eu quero mata todos vocês ..."), 0, 1000);
		...
		private void method_5()
		{
			...
			base.Body.Say("Tranque-os para nós.", 0, 2000);
		...
		private void method_7()
		{
			...
			LivingConfig livingConfig = ((PVEGame)base.Game).BaseConfig();
