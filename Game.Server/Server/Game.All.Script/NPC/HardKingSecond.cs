...
namespace GameServerScript.AI.NPC
{
    public class HardKingSecond : ABrain
    {
        ...
        private Point[] brithPoint = { new Point(682, 673), new Point(1092, 670) };

        #region NPC 说话内容
        private static string[] AllAttackChat = new string[] { 
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg1"),
       
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg2"),
       
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg3")
        };

        private static string[] ShootChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg4"),
                               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg5"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg6")
        };

        private static string[] AddBooldChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg7"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg8"),
                
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg9")
         
        };

        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg10")
        };

        private static string[] FrostChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg11"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg12"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg13")
              
        };

        private static string[] WallChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg14"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg15")
         };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg16"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg17"),

            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg18")
        };

        private static string[] ShootedChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg19"),
                   
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg20")
        };

        private static string[] DiedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg21")
        };
        #endregion
        ...
        private void CriticalStrikes()
        {
            ...
            if (NotFrostPlayers.Count != players.Count)
            {
                ...
                Body.RangeAttacking(Body.X - 1000, Body.X + 1000, "beat1", 1500, NotFrostPlayers, 0);
            }
            else
            {
                Body.Say(LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingSecond.msg22"), 1, 3300);
