...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenSimpleThirdBoss : ABrain
	{
		...
		public ThirteenSimpleThirdBoss()
		{
			...
			this.string_2 = new string[] { "O que há de errado com você?", "Seu idiota não aprende nada.", "Você quer ser esfolado, hein?", "Essa bandeira me aperta?", "Você os está ajudando ou me ajudando?" };
