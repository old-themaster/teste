...
namespace GameServerScript.AI.NPC
{
    public class SeventhSimpleFirstBoss : ABrain
    {
        ...
        private static string[] BeatSay = new string[]{
            ...
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.SeventhSimpleFirstBoss.msg3")
        };

        private static string[] BeatASay = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.SeventhSimpleFirstBoss.msg4"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.SeventhSimpleFirstBoss.msg5"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.SeventhSimpleFirstBoss.msg6")
        };

        private static string[] BeatBSay = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.SeventhSimpleFirstBoss.msg7"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.SeventhSimpleFirstBoss.msg8"),
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.SeventhSimpleFirstBoss.msg3")
        };
