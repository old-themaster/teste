...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenSimpleShadowBoss : ABrain
	{
		...
		public ThirteenSimpleShadowBoss()
		{
			...
			this.int_1 = 13008;
			this.string_0 = new string[] { "Você se lembra do seu pai? "," Você se lembra de mim? ", "Essas pessoas lembram quem somos? " };
			this.HecsVtjkiPK = new string[] { "Vai ficar tudo bem?", "Eu vou matá-los um por um", "Você costumava nos comer cebolas antes. Agora não tente.", "Você será o primeiro alvo que eu mato", "Você será capaz de segurá-lo?" };
			this.string_1 = new string[] { "Você deve morrer todo o camarão", "Não sonhe em ganhar contra mim", "Você acha que pode vencer o AD zai bonito?", "O anúncio não permitirá que você passe. Ahahaa ...", "Feijão mungo matamos todos eles" };
			this.NgNsVudYgCe = new string[] { "Não aguento mais", "Em vez de jogar da maneira antiga. Viga morta", "Se eu morrer, você deve morrer.", "Não suporto se a bandeira estiver sinalizada", "Chega de brincadeira. Todos mortos. Mate todos eles" };
