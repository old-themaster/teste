...
namespace GameServerScript.AI.NPC
{
    public class HardKingZhen : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] {
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg1"),
          
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg2"),
          
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg3"),

             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg4")
        };

        private static string[] ShootChat = new string[]{
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg5"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg6"),
             
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg7"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg8"),
               
             LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg9")          
        };

        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg10")                          
        };

        private static string[] AngryChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg11")                          
        };

        private static string[] KillAttackChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg12")                          
        };

        private static string[] SealChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg13")                          
        };

        private static string[] KillPlayerChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg14"),                  
 
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg15")
        };

        private static string[] ShootedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg16"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg17"),
               
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg18")
        };

        private static string[] DiedChat = new string[]{
            LanguageMgr.GetTranslation("GameServerScript.AI.NPC.HardKingZhen.msg19")
        };
        #endregion
