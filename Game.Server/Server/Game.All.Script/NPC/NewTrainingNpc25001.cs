...
namespace GameServerScript.AI.NPC
{
    public class NewTrainingNpc25001 : ABrain
    {
        ...
        private static string[] listChat = new string[] {
            "Eu fui espancado!",
            "Apenas uma criança que é tão forte?",
            "Eu venho à vingança, tenha cuidado!"
        };
        ...
        /// 小怪说话
        /// </summary>
        public void LivingSay(List<Living> livings)
        {
            ...
            if (sayCount > 0)
            {
                ...
                for (int i = 0; i < sayCount; )
                {
                    ...
                    if (livings[index].IsSay == false)
                    {
                        ...
                        //livings[index].Say(SimpleNpcAi.GetOneChat(this), 0, delay);
                        i++;
                    }
                }
            }
