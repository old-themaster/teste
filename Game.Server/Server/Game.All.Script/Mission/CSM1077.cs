...
namespace GameServerScript.AI.Messions
{
    public class CSM1077 : AMissionControl
    {
        ...
        public override void OnPrepareNewSession()
        {
            ...
            Game.SetMap(1076);
            Game.IsBossWar = LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1077.msg1");
        }
        ...
        public override void OnPrepareNewGame()
        {
            ...
            m_king.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1077.msg2"), 0, 3000);
            m_king.AddDelay(16);
        }
