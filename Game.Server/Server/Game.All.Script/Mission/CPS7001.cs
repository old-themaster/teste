...
{
    public class CPS7001 : AMissionControl
    {
        ...
        private int m_totalRed = 11;

        private int m_totalBlue = 5;
        
        private int maxRedOnMap = 4;
        ...
        private int redNpcID = 7002;

        private int blueNpcID = 7001;
        ...
        public override void OnGameOver()
        {
            ...
            loadingFileInfos.Add(new LoadingFileInfo(2, "image/map/7/show.jpg", ""));
