...
namespace GameServerScript.AI.Messions
{
    ...
    {
        private int bossId = 13305;

        private int npcLeftId = 13303;

        private int npcRightId = 13304;
        ...
        private void CreateBossLeft()
        {
            ...
            npcLeft.SetRelateDemagemRect(npcLeft.NpcInfo.X, npcLeft.NpcInfo.Y, npcLeft.NpcInfo.Width,
                npcLeft.NpcInfo.Height);
        ...
        private void CreateBossRight()
        {
            ...
            npcRight.SetRelateDemagemRect(npcRight.NpcInfo.X, npcRight.NpcInfo.Y, npcRight.NpcInfo.Width,
                npcRight.NpcInfo.Height);
