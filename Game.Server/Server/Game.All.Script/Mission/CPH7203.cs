...
{
    public class CPH7203 : AMissionControl
    {
        private SimpleBoss boss = null;

        private int npcID = 7221; // ga mai

        private int npcID2 = 7222; // ga trong

        private int bossID = 7223; // chuong ga
        ...
        public override void OnStartGame()
        {
            ...
            boss.Say("Não os deixe continuar a penetrar!", 0, 2000, 4000);
        }
