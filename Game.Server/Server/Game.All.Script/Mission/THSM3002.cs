...
{
    public class THSM3002 : AMissionControl
    {
        ...
        private int[] npcIDs = { 3002, 3005 };

        private int bloomIDs = 3007;

        private int bossID = 3019;
        ...
        public override void OnPrepareNewSession()
        {
            ...
            int[] gameOverResources = { npcIDs[1], npcIDs[0] };
        ...
        public override void OnPrepareNewGame()
        {
            ...
            boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.THSM3002.msg3"), 0, 2000, 3000);
        ...
        public void CreateBloomNpc()
        {
            ...
            bloomNpc.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.THSM3002.msg1"), 0, 1500, 3000);
        ...
        public override bool CanGameOver()
        {
            ...
            if (bloomNpc.Blood == bloomNpc.MaxBlood)
            {
                ...
                bloomNpc.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.THSM3002.msg2"), 0, 1500, 0);
