...
{
    public class TNSM3105 : AMissionControl
    {
        ...
        private int bossID = 3114;

        private int battleID = 3115;

        private int bloomID = 3107;
        ...
        public void CreateBoss()
        {
            ...
            guardBoss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.TNSM3105.msg1"), 0, 1100, 5000);
            guardBoss.Degree = 1;
