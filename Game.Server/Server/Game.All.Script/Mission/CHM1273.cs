...
namespace GameServerScript.AI.Messions
{
    public class CHM1273 : AMissionControl
    {
        ...
        public override void OnPrepareNewSession()
        {
            ...
            Game.SetMap(1073);
            Game.IsBossWar = LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1273.msg1");
        }
        ...
        public override void OnPrepareNewGame()
        {
            ...
            m_boss.AddDelay(10);
            m_boss.Say(LanguageMgr.GetTranslation("GameServerScript.AI.Messions.CHM1273.msg2"), 0, 6000);
