...
{
    public class TVT12303 : AMissionControl
	{
        
		private int BossID = 12310;

        private int ChickenNpcID1 = 12309;

        private int ChickenNpcID2 = 12311;

        private int EndChickenID = 12309;
        ...
        public override void OnNewTurnStarted()
        {
            ...
            if (Game.GetNPCLivingWithID(ChickenNpcID1).Length == 0 && Game.GetNPCLivingWithID(ChickenNpcID2).Length == 0)
                CreateChicken();
        }
        ...
        private  void CreateEndChicken()
        {
            ...
            LivingConfig livingConfig = Game.BaseConfig();
        ...
        private void CreateChicken()
        {
            for(int i = 0; i < 15; i++)
            {
                ...
                Game.CreateNpc(Game.Random.Next(50) < 25 ? ChickenNpcID1 : ChickenNpcID2, x, 1023, 1, Game.Random.Next(50) < 25 ? -1 : 1, livingConfig);
            }
