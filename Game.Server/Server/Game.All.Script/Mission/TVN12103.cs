...
{
    public class TVN12103 : AMissionControl
	{
        
		private int BossID = 12110;

        private int ChickenNpcID1 = 12109;

        private int ChickenNpcID2 = 12111;

        private int EndChickenID = 12109;
