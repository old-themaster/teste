...
namespace GameServerScript.AI.Messions
{
    ...
    {
        private int bossAntID = 13201;

        private int bossChickenID = 13202;
        ...
        public override void OnStartGame()
        {
            ...
            bossChicken.SetRelateDemagemRect(bossChicken.NpcInfo.X, bossChicken.NpcInfo.Y, bossChicken.NpcInfo.Width,
                bossChicken.NpcInfo.Height);
        ...
        private void CreateBossAnt()
        {
            ...
            bossAnt.SetRelateDemagemRect(bossAnt.NpcInfo.X, bossAnt.NpcInfo.Y, bossAnt.NpcInfo.Width,
                bossAnt.NpcInfo.Height);
            bossAnt.Delay = 1;
        ...
        {
            base.CanGameOver();
            if ((bossAnt != null && bossAnt.IsLiving == false && bossChicken != null &&
                 bossChicken.IsLiving == false) || Game.TotalTurn > 200)
            {
                return true;
            }
