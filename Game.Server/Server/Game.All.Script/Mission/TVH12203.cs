...
{
    public class TVH12203 : AMissionControl
	{
        
		private int BossID = 12210;

        private int ChickenNpcID1 = 12209;

        private int ChickenNpcID2 = 12211;

        private int EndChickenID = 12209;
