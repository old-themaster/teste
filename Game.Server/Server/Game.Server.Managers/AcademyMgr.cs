...
namespace Game.Server.Managers
{
    public class AcademyMgr
  {
    ...
    public static void UpdateAwardApp(GamePlayer player, int oldLevel)
    {
      ...
      string translation1 = LanguageMgr.GetTranslation("2020 Hocası");
     ...
     // player.Rank.AddRank(translation1,2149);
    ...
    public static bool CheckCanApp(int levelApp) => levelApp >= AcademyMgr.TARGET_PLAYER_MIN_LEVEL && levelApp <= AcademyMgr.ACADEMY_LEVEL_MAX;

    public static bool CheckCanMaster(int levelMaster) => levelMaster >= AcademyMgr.ACADEMY_LEVEL_MIN;
  }
}
