...
namespace Game.Base.Events
{
  public class RoadEventHandlerCollection
  {
    ...
    public void Notify(RoadEvent e) => this.Notify(e, (object) null, (EventArgs) null);

    public void Notify(RoadEvent e, EventArgs args) => this.Notify(e, (object) null, args);

    public void Notify(RoadEvent e, object sender) => this.Notify(e, sender, (EventArgs) null);
