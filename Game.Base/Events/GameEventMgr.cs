...
namespace Game.Base.Events
{
  public sealed class GameEventMgr
  {
    ...
    public static void AddHandler(RoadEvent e, RoadEventHandler del) => GameEventMgr.AddHandler(e, del, false);
    ...
    public static void AddHandler(object obj, RoadEvent e, RoadEventHandler del) => GameEventMgr.AddHandler(obj, e, del, false);
    ...
    public static void AddHandlerUnique(RoadEvent e, RoadEventHandler del) => GameEventMgr.AddHandler(e, del, true);

    public static void AddHandlerUnique(object obj, RoadEvent e, RoadEventHandler del) => GameEventMgr.AddHandler(obj, e, del, true);

    public static void Notify(RoadEvent e) => GameEventMgr.Notify(e, (object) null, (EventArgs) null);

    public static void Notify(RoadEvent e, EventArgs args) => GameEventMgr.Notify(e, (object) null, args);

    public static void Notify(RoadEvent e, object sender) => GameEventMgr.Notify(e, sender, (EventArgs) null);
